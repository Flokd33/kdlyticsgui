shadow$provide.module$node_modules$vega_transforms$build$vega_transforms=function(global$jscomp$0,require,module,exports$jscomp$0){(function(global,factory){"object"===typeof exports$jscomp$0&&"undefined"!==typeof module?factory(exports$jscomp$0,require("module$node_modules$vega_util$build$vega_util"),require("module$node_modules$vega_dataflow$build$vega_dataflow"),require("module$node_modules$vega_statistics$build$vega_statistics"),require("module$node_modules$d3_array$dist$d3_array")):"function"===
typeof define&&define.amd?define(["exports","vega-util","vega-dataflow","vega-statistics","d3-array"],factory):(global=global||self,factory((global.vega=global.vega||{},global.vega.transforms={}),global.vega,global.vega,global.vega,global.d3))})(this,function(exports,vegaUtil,vegaDataflow,vegaStatistics,d3Array){function multikey(f){return function(x){for(var n=f.length,i=1,k=String(f[0](x));i<n;++i)k+="|"+f[i](x);return k}}function groupkey(fields){return fields&&fields.length?1===fields.length?
...
count:counts};if(!countOnly)for(var n$jscomp$0=measures.length,a=cell.agg=Array(n$jscomp$0),i$jscomp$0=0;i$jscomp$0<n$jscomp$0;++i$jscomp$0)a[i$jscomp$0]=new measures[i$jscomp$0](cell);if(cell.store)var store=cell.data=new TupleStore;cell.add=function(t){cell.num+=1;if(!countOnly){store&&store.add(t);for(var i$294=0;i$294<n$jscomp$0;++i$294)a[i$294].add(a[i$294].get(t),t)}};cell.rem=function(t){--cell.num;if(!countOnly){store&&store.rem(t);for(var i$295=0;i$295<n$jscomp$0;++i$295)a[i$295].rem(a[i$295].get(t),
t)}};cell.set=function(t){var n;store&&store.values();var i=0;for(n=counts.length;i<n;++i)t[counts[i]]=cell.num;if(!countOnly)for(i=0,n=a.length;i<n;++i)a[i].set(t)};cell.init=function(){cell.num=0;store&&store.reset();for(var i$296=0;i$296<n$jscomp$0;++i$296)a[i$296].init()};return cell}function Window(params){vegaDataflow.Transform.call(this,{},params);this._mlen=0;this._mods=[]}function processPartition(list,state,cmp,_){var sort=_.sort,range=sort&&!_.ignorePeers;_=_.frame||[null,0];list=list.data(cmp);
...
1E-14,step),n=p.length;pulse.forEach(function(g){for(var q=vegaStatistics.quantiles(g,p),i=0;i<n;++i){for(var t={},i$293=0;i$293<names.length;++i$293)t[names[i$293]]=g.dims[i$293];t[as[0]]=p[i];t[as[1]]=q[i];values.push(vegaDataflow.ingest(t))}});this.value&&(out.rem=this.value);this.value=out.add=out.source=values;return out};vegaUtil.inherits(Relay,vegaDataflow.Transform).transform=function(_,pulse){if(this.value)var lut=this.value;else{var out=pulse=pulse.addAll();lut=this.value={}}_.derive&&(out=
