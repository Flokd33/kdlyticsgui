...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__114821){
var vec__114823 = p__114821;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114823,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114823,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__114832){
var vec__114833 = p__114832;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114833,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114833,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__114842 = cljs.core.first(x);
var fexpr__114841 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__114841.cljs$core$IFn$_invoke$arity$1 ? fexpr__114841.cljs$core$IFn$_invoke$arity$1(G__114842) : fexpr__114841.call(null,G__114842));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__114843 = cljs.core.first(x);
var G__114843__$1 = (((G__114843 instanceof cljs.core.Keyword))?G__114843.fqn:null);
switch (G__114843__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__114843__$1)].join('')));
