...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__53724){
var vec__53725 = p__53724;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53725,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53725,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__53734){
var vec__53735 = p__53734;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53735,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53735,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__53745 = cljs.core.first(x);
var fexpr__53744 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__53744.cljs$core$IFn$_invoke$arity$1 ? fexpr__53744.cljs$core$IFn$_invoke$arity$1(G__53745) : fexpr__53744.call(null,G__53745));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__53746 = cljs.core.first(x);
var G__53746__$1 = (((G__53746 instanceof cljs.core.Keyword))?G__53746.fqn:null);
switch (G__53746__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53746__$1)].join('')));
