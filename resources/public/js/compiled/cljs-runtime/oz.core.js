...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__68014){
var vec__68015 = p__68014;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68015,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68015,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__68022){
var vec__68023 = p__68022;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68023,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68023,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__68033 = cljs.core.first(x);
var fexpr__68032 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__68032.cljs$core$IFn$_invoke$arity$1 ? fexpr__68032.cljs$core$IFn$_invoke$arity$1(G__68033) : fexpr__68032.call(null,G__68033));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__68034 = cljs.core.first(x);
var G__68034__$1 = (((G__68034 instanceof cljs.core.Keyword))?G__68034.fqn:null);
switch (G__68034__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68034__$1)].join('')));
