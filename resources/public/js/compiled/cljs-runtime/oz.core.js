...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__94428){
var vec__94429 = p__94428;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94429,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94429,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__94432){
var vec__94433 = p__94432;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94433,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94433,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__94439 = cljs.core.first(x);
var fexpr__94438 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__94438.cljs$core$IFn$_invoke$arity$1 ? fexpr__94438.cljs$core$IFn$_invoke$arity$1(G__94439) : fexpr__94438.call(null,G__94439));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__94440 = cljs.core.first(x);
var G__94440__$1 = (((G__94440 instanceof cljs.core.Keyword))?G__94440.fqn:null);
switch (G__94440__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__94440__$1)].join('')));
