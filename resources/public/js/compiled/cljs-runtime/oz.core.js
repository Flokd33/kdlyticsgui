...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__49107){
var vec__49108 = p__49107;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49108,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49108,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__49111){
var vec__49112 = p__49111;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49112,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49112,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__49118 = cljs.core.first(x);
var fexpr__49117 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__49117.cljs$core$IFn$_invoke$arity$1 ? fexpr__49117.cljs$core$IFn$_invoke$arity$1(G__49118) : fexpr__49117.call(null,G__49118));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__49119 = cljs.core.first(x);
var G__49119__$1 = (((G__49119 instanceof cljs.core.Keyword))?G__49119.fqn:null);
switch (G__49119__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49119__$1)].join('')));
