...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__74128){
var vec__74129 = p__74128;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74129,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74129,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__74136){
var vec__74137 = p__74136;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74137,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74137,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__74146 = cljs.core.first(x);
var fexpr__74145 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__74145.cljs$core$IFn$_invoke$arity$1 ? fexpr__74145.cljs$core$IFn$_invoke$arity$1(G__74146) : fexpr__74145.call(null,G__74146));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__74149 = cljs.core.first(x);
var G__74149__$1 = (((G__74149 instanceof cljs.core.Keyword))?G__74149.fqn:null);
switch (G__74149__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74149__$1)].join('')));
