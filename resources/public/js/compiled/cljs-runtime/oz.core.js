...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__58073){
var vec__58074 = p__58073;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58074,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58074,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__58084){
var vec__58085 = p__58084;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58085,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58085,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__58096 = cljs.core.first(x);
var fexpr__58095 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__58095.cljs$core$IFn$_invoke$arity$1 ? fexpr__58095.cljs$core$IFn$_invoke$arity$1(G__58096) : fexpr__58095.call(null,G__58096));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58100 = cljs.core.first(x);
var G__58100__$1 = (((G__58100 instanceof cljs.core.Keyword))?G__58100.fqn:null);
switch (G__58100__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58100__$1)].join('')));
