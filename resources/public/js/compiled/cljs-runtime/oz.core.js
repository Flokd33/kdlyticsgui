...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__62628){
var vec__62629 = p__62628;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62629,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62629,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__62632){
var vec__62633 = p__62632;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62633,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62633,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__62639 = cljs.core.first(x);
var fexpr__62638 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__62638.cljs$core$IFn$_invoke$arity$1 ? fexpr__62638.cljs$core$IFn$_invoke$arity$1(G__62639) : fexpr__62638.call(null,G__62639));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__62640 = cljs.core.first(x);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62640__$1)].join('')));
