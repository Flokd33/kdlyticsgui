...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__47746){
var vec__47747 = p__47746;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47747,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47747,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__47750){
var vec__47751 = p__47750;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47751,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47751,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__47758 = cljs.core.first(x);
var fexpr__47757 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__47757.cljs$core$IFn$_invoke$arity$1 ? fexpr__47757.cljs$core$IFn$_invoke$arity$1(G__47758) : fexpr__47757.call(null,G__47758));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__47759 = cljs.core.first(x);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47759__$1)].join('')));
