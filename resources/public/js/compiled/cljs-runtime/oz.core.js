...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__47774){
var vec__47775 = p__47774;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47775,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47775,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__47778){
var vec__47779 = p__47778;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47779,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47779,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__47785 = cljs.core.first(x);
var fexpr__47784 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__47784.cljs$core$IFn$_invoke$arity$1 ? fexpr__47784.cljs$core$IFn$_invoke$arity$1(G__47785) : fexpr__47784.call(null,G__47785));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__47786 = cljs.core.first(x);
var G__47786__$1 = (((G__47786 instanceof cljs.core.Keyword))?G__47786.fqn:null);
switch (G__47786__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47786__$1)].join('')));
