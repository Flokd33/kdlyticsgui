...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__50154){
var vec__50155 = p__50154;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50155,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50155,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__50160){
var vec__50161 = p__50160;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50161,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50161,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__50173 = cljs.core.first(x);
var fexpr__50172 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__50172.cljs$core$IFn$_invoke$arity$1 ? fexpr__50172.cljs$core$IFn$_invoke$arity$1(G__50173) : fexpr__50172.call(null,G__50173));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__50180 = cljs.core.first(x);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50180__$1)].join('')));
