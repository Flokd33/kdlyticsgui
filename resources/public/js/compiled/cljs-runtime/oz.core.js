...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__86119){
var vec__86120 = p__86119;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86120,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86120,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__86123){
var vec__86124 = p__86123;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86124,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86124,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__86130 = cljs.core.first(x);
var fexpr__86129 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__86129.cljs$core$IFn$_invoke$arity$1 ? fexpr__86129.cljs$core$IFn$_invoke$arity$1(G__86130) : fexpr__86129.call(null,G__86130));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__86131 = cljs.core.first(x);
var G__86131__$1 = (((G__86131 instanceof cljs.core.Keyword))?G__86131.fqn:null);
switch (G__86131__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__86131__$1)].join('')));
