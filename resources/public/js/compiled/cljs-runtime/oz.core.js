...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__101291){
var vec__101292 = p__101291;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101292,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101292,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__101295){
var vec__101296 = p__101295;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101296,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101296,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__101302 = cljs.core.first(x);
var fexpr__101301 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__101301.cljs$core$IFn$_invoke$arity$1 ? fexpr__101301.cljs$core$IFn$_invoke$arity$1(G__101302) : fexpr__101301.call(null,G__101302));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__101303 = cljs.core.first(x);
var G__101303__$1 = (((G__101303 instanceof cljs.core.Keyword))?G__101303.fqn:null);
switch (G__101303__$1) {
case "vega":
return oz.core.vega;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__101303__$1)].join('')));
