...
var data = cljs.core.deref((function (){var G__72675 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","chart-data","single-bond-trade-history/chart-data",-652303632)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72675) : re_frame.core.subscribe.call(null,G__72675));
})());
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("single-bond-trade-history","close-modal","single-bond-trade-history/close-modal",1822468773),(function (db,p__72678){
var vec__72680 = p__72678;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72680,(0),null);
...
var G__72693_72828 = new cljs.core.Keyword("single-bond-trade-history","chart-data","single-bond-trade-history/chart-data",-652303632);
var G__72694_72829 = (function (db){
var portfolio = (function (){var G__72695 = new cljs.core.Keyword("single-portfolio-risk","portfolio","single-portfolio-risk/portfolio",837005949);
return (db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(G__72695) : db.call(null,G__72695));
})();
var name = (function (){var G__72696 = new cljs.core.Keyword("bond-price-history","name","bond-price-history/name",-1471022397);
return (db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(G__72696) : db.call(null,G__72696));
})();
var data = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,new cljs.core.Keyword(null,"price","price",22129180)),(function (){var G__72699 = new cljs.core.Keyword("bond-price-history","price","bond-price-history/price",-601066058);
return (db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(G__72699) : db.call(null,G__72699));
})());
var trade_data = cljs.core.reverse(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__72687_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"TransactionTypeName","TransactionTypeName",941925643).cljs$core$IFn$_invoke$arity$1(p1__72687_SHARP_),"Coupon Payment");
}),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2((function (){var G__72707 = new cljs.core.Keyword("single-bond-trade-history","data","single-bond-trade-history/data",-806149127);
return (db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(G__72707) : db.call(null,G__72707));
...
var buys = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__4529__auto__ = (function jasminegui$tradehistory$iter__72708(s__72709){
return (new cljs.core.LazySeq(null,(function (){
var s__72709__$1 = s__72709;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__72709__$1);
if(temp__5735__auto__){
var s__72709__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__72709__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__72709__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__72711 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__72710 = (0);
while(true){
if((i__72710 < size__4528__auto__)){
var line = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__72710);
cljs.core.chunk_append(b__72711,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"date","date",-1463434462),clojure.string.replace(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"TradeDate","TradeDate",-1661497901).cljs$core$IFn$_invoke$arity$1(line),(0),(10)),"-",""),new cljs.core.Keyword(null,"buy","buy",-794379565),new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line),new cljs.core.Keyword(null,"value","value",305978217),((0.01 * new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line)) * new cljs.core.Keyword(null,"Quantity","Quantity",-1939883397).cljs$core$IFn$_invoke$arity$1(line))], null));

var G__72850 = (i__72710 + (1));
i__72710 = G__72850;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__72711),jasminegui$tradehistory$iter__72708(cljs.core.chunk_rest(s__72709__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__72711),null);
}
} else {
var line = cljs.core.first(s__72709__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"date","date",-1463434462),clojure.string.replace(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"TradeDate","TradeDate",-1661497901).cljs$core$IFn$_invoke$arity$1(line),(0),(10)),"-",""),new cljs.core.Keyword(null,"buy","buy",-794379565),new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line),new cljs.core.Keyword(null,"value","value",305978217),((0.01 * new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line)) * new cljs.core.Keyword(null,"Quantity","Quantity",-1939883397).cljs$core$IFn$_invoke$arity$1(line))], null),jasminegui$tradehistory$iter__72708(cljs.core.rest(s__72709__$2)));
}
} else {
return null;
}
...
var sells = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__4529__auto__ = (function jasminegui$tradehistory$iter__72735(s__72736){
return (new cljs.core.LazySeq(null,(function (){
var s__72736__$1 = s__72736;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__72736__$1);
if(temp__5735__auto__){
var s__72736__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__72736__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__72736__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__72738 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__72737 = (0);
while(true){
if((i__72737 < size__4528__auto__)){
var line = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__72737);
cljs.core.chunk_append(b__72738,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"date","date",-1463434462),clojure.string.replace(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"TradeDate","TradeDate",-1661497901).cljs$core$IFn$_invoke$arity$1(line),(0),(10)),"-",""),new cljs.core.Keyword(null,"sell","sell",-1949004143),new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line),new cljs.core.Keyword(null,"value","value",305978217),((0.01 * new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line)) * new cljs.core.Keyword(null,"Quantity","Quantity",-1939883397).cljs$core$IFn$_invoke$arity$1(line))], null));

var G__72858 = (i__72737 + (1));
i__72737 = G__72858;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__72738),jasminegui$tradehistory$iter__72735(cljs.core.chunk_rest(s__72736__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__72738),null);
}
} else {
var line = cljs.core.first(s__72736__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"date","date",-1463434462),clojure.string.replace(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"TradeDate","TradeDate",-1661497901).cljs$core$IFn$_invoke$arity$1(line),(0),(10)),"-",""),new cljs.core.Keyword(null,"sell","sell",-1949004143),new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line),new cljs.core.Keyword(null,"value","value",305978217),((0.01 * new cljs.core.Keyword(null,"PriceLcl","PriceLcl",1537035944).cljs$core$IFn$_invoke$arity$1(line)) * new cljs.core.Keyword(null,"Quantity","Quantity",-1939883397).cljs$core$IFn$_invoke$arity$1(line))], null),jasminegui$tradehistory$iter__72735(cljs.core.rest(s__72736__$2)));
}
} else {
return null;
}
...
var pos_line = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__72688_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"NAME","NAME",-1127916515).cljs$core$IFn$_invoke$arity$1(p1__72688_SHARP_),name)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"portfolio","portfolio",957568598).cljs$core$IFn$_invoke$arity$1(p1__72688_SHARP_),portfolio)));
}),(function (){var G__72753 = new cljs.core.Keyword(null,"positions","positions",-1380538434);
return (db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(G__72753) : db.call(null,G__72753));
})()));
...
var rbydate = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__72689_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__72689_SHARP_,new cljs.core.Keyword(null,"trade-nav","trade-nav",895783743),(function (){var temp__5733__auto__ = new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__72689_SHARP_);
if(cljs.core.truth_(temp__5733__auto__)){
var x = temp__5733__auto__;
return (x / fund_nav);
} else {
...
var rwchange = cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__72690_SHARP_,p2__72691_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__72690_SHARP_,new cljs.core.Keyword(null,"nav","nav",719540477),(nav - p2__72691_SHARP_));
...
var final$ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__72692_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__72692_SHARP_,new cljs.core.Keyword(null,"nav","nav",719540477),cljs.core._STAR_,(100));
}),rwchange);
return final$;
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__72693_72828,G__72694_72829) : re_frame.core.reg_sub.call(null,G__72693_72828,G__72694_72829));
jasminegui.tradehistory.modal_single_bond_trade_history = (function jasminegui$tradehistory$modal_single_bond_trade_history(){
var modal_data = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref((function (){var G__72758 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","data","single-bond-trade-history/data",-806149127)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72758) : re_frame.core.subscribe.call(null,G__72758));
})()),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref((function (){var G__72759 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-portfolio-risk","portfolio","single-portfolio-risk/portfolio",837005949)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72759) : re_frame.core.subscribe.call(null,G__72759));
})()))], null));
var show_modal = cljs.core.deref((function (){var G__72760 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","show-modal","single-bond-trade-history/show-modal",-1585088359)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72760) : re_frame.core.subscribe.call(null,G__72760));
})());
var display = cljs.core.reverse(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__72756_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"TransactionTypeName","TransactionTypeName",941925643).cljs$core$IFn$_invoke$arity$1(p1__72756_SHARP_),"Coupon Payment");
}),modal_data));
cljs.core.deref((function (){var G__72761 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","chart-data","single-bond-trade-history/chart-data",-652303632)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72761) : re_frame.core.subscribe.call(null,G__72761));
})());
...
var G__72762 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","close-modal","single-bond-trade-history/close-modal",1822468773)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__72762) : re_frame.core.dispatch.call(null,G__72762));
}),new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"gap","gap",80255254),"20px",new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.title,new cljs.core.Keyword(null,"label","label",1718410804),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref((function (){var G__72764 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","bond","single-bond-trade-history/bond",2015871973)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72764) : re_frame.core.subscribe.call(null,G__72764));
...
})], null)], null)], null),(cljs.core.truth_(cljs.core.deref((function (){var G__72765 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","show-throbber","single-bond-trade-history/show-throbber",-76615865)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72765) : re_frame.core.subscribe.call(null,G__72765));
...
var modal_data = cljs.core.deref((function (){var G__72773 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","flat-data","single-bond-trade-history/flat-data",-296971181)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72773) : re_frame.core.subscribe.call(null,G__72773));
})());
var show_modal = cljs.core.deref((function (){var G__72775 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","show-flat-modal","single-bond-trade-history/show-flat-modal",1072491400)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72775) : re_frame.core.subscribe.call(null,G__72775));
})());
var bond_name = cljs.core.deref((function (){var G__72776 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","bond","single-bond-trade-history/bond",2015871973)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72776) : re_frame.core.subscribe.call(null,G__72776));
})());
var display = cljs.core.reverse(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"date","date",-1463434462),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__72768_SHARP_){
return cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([new cljs.core.Keyword(null,"trade","trade",123337743).cljs$core$IFn$_invoke$arity$1(p1__72768_SHARP_)]),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Coupon Payment","Scrip Transfer"], null));
}),modal_data)));
if(cljs.core.truth_(show_modal)){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.modal_panel,new cljs.core.Keyword(null,"wrap-nicely?","wrap-nicely?",85012288),true,new cljs.core.Keyword(null,"backdrop-on-click","backdrop-on-click",-1460240426),(function (){
var G__72780 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("single-bond-trade-history","close-modal","single-bond-trade-history/close-modal",1822468773)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__72780) : re_frame.core.dispatch.call(null,G__72780));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__72789),jasminegui$tradehistory$modal_single_bond_flat_trade_history_$_iter__72786(cljs.core.chunk_rest(s__72787__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__72789),null);
}
} else {
var p = cljs.core.first(s__72787__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"Header","Header",1255420133),p,new cljs.core.Keyword(null,"accessor","accessor",-25476721),p,new cljs.core.Keyword(null,"width","width",-384071477),(90),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"textAlign","textAlign",-711351626),"right"], null),new cljs.core.Keyword(null,"Cell","Cell",53644787),jasminegui.tradehistory.nfh], null),jasminegui$tradehistory$modal_single_bond_flat_trade_history_$_iter__72786(cljs.core.rest(s__72787__$2)));
}
} else {
return null;
}
...
return iter__4529__auto__(cljs.core.deref((function (){var G__72799 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"portfolios","portfolios",-2020870213)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__72799) : re_frame.core.subscribe.call(null,G__72799));
})()));
