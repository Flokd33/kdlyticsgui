...
var o45391 = temp__5733__auto__;
var temp__5733__auto____$1 = (o45391["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o45392 = temp__5733__auto____$1;
return (o45392["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41433__auto__ = f;
return (o__41433__auto__["toString"]).call(o__41433__auto__);
} else {
return "";
}
}catch (e45394){var _ = e45394;
return "";
}});
...
try{var o__41433__auto___45678 = t;
(o__41433__auto___45678["cljs$lang$ctorPrWriter"]).call(o__41433__auto___45678,t,writer);
}catch (e45397){var __45681 = e45397;
}
...
var char_code = (function (){var o__41433__auto__ = (new String(char$));
return (o__41433__auto__["charCodeAt"]).call(o__41433__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41433__auto__ = String;
return (o__41433__auto__["fromCharCode"]).call(o__41433__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45401 = num_code;
switch (G__45401) {
case (1):
return (185);
...
var o__41433__auto__ = String;
return (o__41433__auto__["fromCharCode"]).call(o__41433__auto__,superscript_code);
});
/**
...
}catch (e45407){var _e__41440__auto__ = e45407;
return false;
}})())){
...
var vec__45408 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45408,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o45411 = temp__5733__auto__;
var temp__5733__auto____$1 = (o45411["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o45412 = temp__5733__auto____$1;
return (o45412["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45416){
var vec__45417 = p__45416;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45417,(0),null);
...
var G__45721 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__45722 = cljs.core.butlast(remaining_tokens);
name_tokens = G__45721;
remaining_tokens = G__45722;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45413){
...
var vec__45422 = cljs.core.split_with((function (p1__45421_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__45421_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45422,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45422,(1),null);
...
var vec__45428 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45428,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45428,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__45743 = cljs.core.rest(remaining_tokens);
var G__45744 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__45743;
name_tokens = G__45744;
continue;
} else {
...
var vec__45433 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45433,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45433,(1),null);
var vec__45436 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45436,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45436,(1),null);
var vec__45439 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45439,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45439,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45439,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45439,(3),null);
...
var vec__45444 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45444,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45444,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45444,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45444,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45444,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45444,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__45447 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45447,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45447,(1),null);
var vec__45450 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45450,(0),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__45455 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__45455) : devtools.munging.parse_fn_info_deep.call(null,G__45455));
})()));
}
} else {
return fn_info;
...
var G__45765 = (arity + (1));
var G__45766 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45470){
var vec__45471 = p__45470;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45471,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45471,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45485_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__45485_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45490_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__45490_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___45777 = arguments.length;
var i__4737__auto___45778 = (0);
while(true){
if((i__4737__auto___45778 < len__4736__auto___45777)){
args__4742__auto__.push((arguments[i__4737__auto___45778]));

var G__45779 = (i__4737__auto___45778 + (1));
i__4737__auto___45778 = G__45779;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45498){
var vec__45499 = p__45498;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45499,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45493){
var G__45494 = cljs.core.first(seq45493);
var seq45493__$1 = cljs.core.next(seq45493);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45494,seq45493__$1);
}));
...
var G__45506 = arg;
var G__45506__$1 = (((G__45506 instanceof cljs.core.Keyword))?G__45506.fqn:null);
switch (G__45506__$1) {
...
var map__45535 = options;
var map__45535__$1 = (((((!((map__45535 == null))))?(((((map__45535.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45535.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45535):map__45535);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45535__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45535__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45535__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45535__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45536 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45536,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45536,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45536,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45536,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45536,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45536,(5),null);
...
var o__41433__auto__ = f;
return (o__41433__auto__["getBasis"]).call(o__41433__auto__);
});
/**
...
}catch (e45556){var _e__41440__auto__ = e45556;
...
var G__45785 = (obj[cljs.core.first(path)]);
var G__45786 = cljs.core.rest(path);
obj = G__45785;
path = G__45786;
continue;
} else {
...
var _STAR_ = (function (accum,p__45600){
var vec__45601 = p__45600;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45601,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45601,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__45620){
var vec__45625 = p__45620;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45625,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45625,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45625,(2),null);
...
var post_process = (function (p__45652){
var vec__45653 = p__45652;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45653,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45653,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45641_SHARP_){
return (obj[cljs.core.first(p1__45641_SHARP_)]);
}),sorted_matches);
