...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31690 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31690(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31693 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31693(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31699 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31699(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31701 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31701(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31704 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31704(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31709 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31709(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31710 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31710(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31711 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31711(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31713 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31713(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31718 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31718(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31720 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31720(b);
}
});
