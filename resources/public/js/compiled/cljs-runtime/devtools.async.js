...
var o__41732__auto___46087 = (function (){var o__41732__auto__ = (function (){var o__41732__auto__ = Promise;
return (o__41732__auto__["resolve"]).call(o__41732__auto__);
})();
return (o__41732__auto__["then"]).call(o__41732__auto__,callback);
})();
(o__41732__auto___46087["catch"]).call(o__41732__auto___46087,devtools.async.rethrow_outside_promise);
...
var G__46086_46088 = Error;
var target__41749__auto___46089 = G__46086_46088;
if(cljs.core.truth_(target__41749__auto___46089)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46086_46088)].join(''),"\n","target__41749__auto__"].join('')));
}

(target__41749__auto___46089["stackTraceLimit"] = Infinity);
