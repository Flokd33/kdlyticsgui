...
function parsePrimaryExpression(){if(match("(")){expect("(");var type=parseExpression();expect(")");return type}if(match("[")){type=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),type.push(null)):(type.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_4031=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_4031.elements=type;return JSCompiler_object_inline_value_4031}if(match("{")){type=[];JSCompiler_object_inline_value_4031=
{};var JSCompiler_object_inline_literal_4032=String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_4033=lookahead;if(3===JSCompiler_object_inline_value_4033.type){var JSCompiler_object_inline_literal_4034=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_4033=parseConditionalExpression();JSCompiler_object_inline_value_4033=finishProperty("init",JSCompiler_object_inline_literal_4034,JSCompiler_object_inline_value_4033)}else 2===
JSCompiler_object_inline_value_4033.type||7===JSCompiler_object_inline_value_4033.type?(throwUnexpected(JSCompiler_object_inline_value_4033),JSCompiler_object_inline_value_4033=void 0):(JSCompiler_object_inline_literal_4034=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_4033=parseConditionalExpression(),JSCompiler_object_inline_value_4033=finishProperty("init",JSCompiler_object_inline_literal_4034,JSCompiler_object_inline_value_4033));JSCompiler_object_inline_literal_4034="Identifier"===
JSCompiler_object_inline_value_4033.key.type?JSCompiler_object_inline_value_4033.key.name:JSCompiler_object_inline_literal_4032(JSCompiler_object_inline_value_4033.key.value);JSCompiler_object_inline_literal_4034="$"+JSCompiler_object_inline_literal_4034;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_4031,JSCompiler_object_inline_literal_4034)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_4031[JSCompiler_object_inline_literal_4034]=
!0;type.push(JSCompiler_object_inline_value_4033);match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_4031=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_4031.properties=type;return JSCompiler_object_inline_value_4031}type=lookahead.type;index$jscomp$0=lookahead.start;if(3===type||legalKeywords[lookahead.value])JSCompiler_object_inline_value_4031=finishIdentifier(lex().value);else if(8===type||6===type)lookahead.octal&&throwError(lookahead,"Octal literals are not allowed in strict mode."),
JSCompiler_object_inline_value_4031=finishLiteral(lex());else{if(4===type)throw Error("Disabled.");if(1===type)type=lex(),type.value="true"===type.value,JSCompiler_object_inline_value_4031=finishLiteral(type);else if(5===type)type=lex(),type.value=null,JSCompiler_object_inline_value_4031=finishLiteral(type);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();type=index$jscomp$0;JSCompiler_object_inline_value_4031=source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_4031,
"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_4032=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_4034=JSCompiler_object_inline_value_4033=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_4031=source[index$jscomp$0++],JSCompiler_object_inline_literal_4032+=JSCompiler_object_inline_value_4031,"\\"===JSCompiler_object_inline_value_4031)JSCompiler_object_inline_value_4031=source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_4031.charCodeAt(0))&&
throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_4032+=JSCompiler_object_inline_value_4031;else if(isLineTerminator(JSCompiler_object_inline_value_4031.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_4033)"]"===JSCompiler_object_inline_value_4031&&(JSCompiler_object_inline_value_4033=!1);else if("/"===JSCompiler_object_inline_value_4031){JSCompiler_object_inline_literal_4034=!0;break}else"["===JSCompiler_object_inline_value_4031&&
(JSCompiler_object_inline_value_4033=!0);JSCompiler_object_inline_literal_4034||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_4031=JSCompiler_object_inline_literal_4032.substr(1,JSCompiler_object_inline_literal_4032.length-2);for(value=JSCompiler_object_inline_literal_4034="";index$jscomp$0<length;){JSCompiler_object_inline_value_4033=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_4033.charCodeAt(0)))break;++index$jscomp$0;"\\"===
JSCompiler_object_inline_value_4033&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_4033,JSCompiler_object_inline_literal_4034+=JSCompiler_object_inline_value_4033)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_4033=value;value=testRegExp(JSCompiler_object_inline_value_4031,JSCompiler_object_inline_value_4033);JSCompiler_object_inline_value_4031=finishLiteral({literal:JSCompiler_object_inline_literal_4032+
JSCompiler_object_inline_literal_4034,value:value,regex:{pattern:JSCompiler_object_inline_value_4031,flags:JSCompiler_object_inline_value_4033},start:type,end:index$jscomp$0});peek()}else throwUnexpected(lex())}return JSCompiler_object_inline_value_4031}function parsePostfixExpression(){var expr;for(expr=parsePrimaryExpression();;)if(match(".")){expect(".");index$jscomp$0=lookahead.start;var args=lex();3===args.type||4===args.type||1===args.type||5===args.type||throwUnexpected(args);args=finishIdentifier(args.value);
