...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40674 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40674(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40675 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40675(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40679 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40679(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40682 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40682(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40683 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40683(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40686 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40686(reader);
}
});
...
var G__40698 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40699 = s.append(c);
c = G__40698;
s = G__40699;
continue;
}
