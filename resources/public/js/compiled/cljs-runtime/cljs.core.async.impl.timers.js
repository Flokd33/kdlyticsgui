...
var i_33511 = (0);
while(true){
if((i_33511 < arr.length)){
(arr[i_33511] = null);

var G__33512 = (i_33511 + (1));
i_33511 = G__33512;
continue;
} else {
}
...
var i_33519 = (self__.level + (1));
while(true){
if((i_33519 <= (new_level + (1)))){
(update[i_33519] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_33521 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33521[i]));
} else {
x__$2.forward.push((((i < links_33521.length))?(links_33521[i]):null));
}

if((i < links_33521.length)){
(links_33521[i] = x__$2);
} else {
links_33521.push(x__$2);
}
...
var i_33523 = (0);
while(true){
if((i_33523 <= self__.level)){
var links_33524 = (update[i_33523]).forward;
if((x__$1 === (((i_33523 < links_33524.length))?(links_33524[i_33523]):null))){
(links_33524[i_33523] = (x__$1.forward[i_33523]));

var G__33525 = (i_33523 + (1));
i_33523 = G__33525;
continue;
} else {
var G__33526 = (i_33523 + (1));
i_33523 = G__33526;
continue;
}
} else {
...
var G__33528 = nx;
var G__33529 = (level__$1 - (1));
x = G__33528;
level__$1 = G__33529;
continue;
} else {
var G__33530 = x;
var G__33531 = (level__$1 - (1));
x = G__33530;
level__$1 = G__33531;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33533 = nx;
var G__33534 = (level__$1 - (1));
x = G__33533;
level__$1 = G__33534;
continue;
} else {
var G__33535 = x;
var G__33536 = (level__$1 - (1));
x = G__33535;
level__$1 = G__33536;
continue;
}
