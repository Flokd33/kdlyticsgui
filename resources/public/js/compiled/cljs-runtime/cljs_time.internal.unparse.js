...
var periods__$1 = cljs.core.vec((function (){var G__42068 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42067_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__42067_SHARP_,(0),(3));
}),G__42068);
} else {
return G__42068;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__42074){
var vec__42075 = p__42074;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42075,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42075,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__42078 = pattern;
switch (G__42078) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42078)].join('')));
...
var G__42087 = key;
var G__42087__$1 = (((G__42087 instanceof cljs.core.Keyword))?G__42087.fqn:null);
switch (G__42087__$1) {
case "millis":
return (function (p1__42079_SHARP_){
return p1__42079_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__42080_SHARP_){
return p1__42080_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__42081_SHARP_){
return p1__42081_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__42082_SHARP_){
return p1__42082_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__42083_SHARP_){
return p1__42083_SHARP_.getHours();
});

break;
case "day":
return (function (p1__42084_SHARP_){
return p1__42084_SHARP_.getDate();
});

break;
case "month":
return (function (p1__42085_SHARP_){
return p1__42085_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__42086_SHARP_){
return p1__42086_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42087__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__42088){
var vec__42089 = p__42088;
var seq__42090 = cljs.core.seq(vec__42089);
var first__42091 = cljs.core.first(seq__42090);
var seq__42090__$1 = cljs.core.next(seq__42090);
var key = first__42091;
var args = seq__42090__$1;
var G__42092 = key;
...
break;
case "ordinal-suffix":
var vec__42093 = (function (){var G__42096 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__42096) : syntax_list.call(null,G__42096));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42093,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42092__$1)].join('')));
...
var d = value;
var G__42100 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
...
var unparser = first__42103;
var more = seq__42102__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__42110 = G__42100__$1;
var seq__42111 = cljs.core.seq(vec__42110);
var first__42112 = cljs.core.first(seq__42111);
var seq__42111__$1 = cljs.core.next(seq__42111);
var unparser__$1 = first__42112;
var more__$1 = seq__42111__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__42113 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42113,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42113,(1),null);
var G__42142 = d__$3;
var G__42143 = more__$1;
var G__42144 = s__$3;
d__$1 = G__42142;
G__42100__$1 = G__42143;
s__$1 = G__42144;
continue;
}
break;
