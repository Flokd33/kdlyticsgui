...
return [(function (){var pred__42463 = cljs.core.instance_QMARK_;
var expr__42464 = reactive_val;
if(cljs.core.truth_((pred__42463.cljs$core$IFn$_invoke$arity$2 ? pred__42463.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42464) : pred__42463.call(null,reagent.ratom.RAtom,expr__42464)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42463.cljs$core$IFn$_invoke$arity$2 ? pred__42463.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42464) : pred__42463.call(null,reagent.ratom.RCursor,expr__42464)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42463.cljs$core$IFn$_invoke$arity$2 ? pred__42463.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42464) : pred__42463.call(null,reagent.ratom.Reaction,expr__42464)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42463.cljs$core$IFn$_invoke$arity$2 ? pred__42463.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42464) : pred__42463.call(null,reagent.ratom.Track,expr__42464)))){
return "tr";
} else {
return "other";
}
