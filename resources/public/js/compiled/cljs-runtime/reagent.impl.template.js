...
var G__39333 = o;
reagent.impl.template.goog$module$goog$object.set(G__39333,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__39351__delegate = function (args){
...
while (G__39352__i < G__39352__a.length) {G__39352__a[G__39352__i] = arguments[G__39352__i + 0]; ++G__39352__i;}
  args = new cljs.core.IndexedSeq(G__39352__a,0,null);
} 
return G__39351__delegate.call(this,args);};
G__39351.cljs$lang$maxFixedArity = 0;
G__39351.cljs$lang$applyTo = (function (arglist__39353){
var args = cljs.core.seq(arglist__39353);
return G__39351__delegate(args);
});
...
var G__39334 = o;
reagent.impl.template.goog$module$goog$object.set(G__39334,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__39335 = props;
var G__39335__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39335,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39335);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39335__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39336 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39336,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39336;
}
})(),id_class);
...
var G__39337 = (cljs.core.count(argv) - first_child);
switch (G__39337) {
case (0):
...
var vec__39338 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39338,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39338,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39338,(2),null);
...
var temp__5808__auto___39360 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___39360 == null)){
} else {
var key_39361 = temp__5808__auto___39360;
(jsprops.key = key_39361);
}
...
var temp__5808__auto___39364 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___39364 == null)){
} else {
var key_39365 = temp__5808__auto___39364;
(jsprops.key = key_39365);
}
...
var temp__5808__auto___39388 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___39388 == null)){
} else {
var key_39389 = temp__5808__auto___39388;
...
var temp__5808__auto___39390 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___39390 == null)){
} else {
var key_39391 = temp__5808__auto___39390;
...
var temp__5808__auto___39392 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___39392 == null)){
} else {
var key_39393 = temp__5808__auto___39392;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39341_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39341_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39342 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39342,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39342,(1),null);
...
break;
default:
var G__39396 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39397 = compiler;
v = G__39396;
compiler = G__39397;
continue;
...
var G__39346 = tag;
var G__39346__$1 = (((G__39346 instanceof cljs.core.Keyword))?G__39346.fqn:null);
switch (G__39346__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template39348 = (function (opts,id,fn_to_element,parse_fn,meta39349){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39348.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39350,meta39349__$1){
var self__ = this;
var _39350__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39348(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39349__$1));
}));

(reagent.impl.template.t_reagent$impl$template39348.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39350){
var self__ = this;
var _39350__$1 = this;
return self__.meta39349;
}));

(reagent.impl.template.t_reagent$impl$template39348.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39348.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39348.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39348.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39348.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39348.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39349","meta39349",-304772925,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39348.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39348.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39348");

(reagent.impl.template.t_reagent$impl$template39348.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template39348");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39348.
 */
reagent.impl.template.__GT_t_reagent$impl$template39348 = (function reagent$impl$template$__GT_t_reagent$impl$template39348(opts,id,fn_to_element,parse_fn,meta39349){
return (new reagent.impl.template.t_reagent$impl$template39348(opts,id,fn_to_element,parse_fn,meta39349));
});
...
return (new reagent.impl.template.t_reagent$impl$template39348(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
