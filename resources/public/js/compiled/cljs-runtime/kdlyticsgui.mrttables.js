...
var pred__46431 = cljs.core._GT_;
var expr__46432 = x;
if(cljs.core.truth_((pred__46431.cljs$core$IFn$_invoke$arity$2 ? pred__46431.cljs$core$IFn$_invoke$arity$2((-500),expr__46432) : pred__46431.call(null,(-500),expr__46432)))){
return ({"sx": ({"cursor": "pointer", "backgroundColor": "#f08080"})});
} else {
if(cljs.core.truth_((pred__46431.cljs$core$IFn$_invoke$arity$2 ? pred__46431.cljs$core$IFn$_invoke$arity$2((500),expr__46432) : pred__46431.call(null,(500),expr__46432)))){
return ({});
} else {
...
kdlyticsgui.mrttables.full_row_formatting = (function kdlyticsgui$mrttables$full_row_formatting(this$){
var temp__5802__auto__ = kdlyticsgui.mrttables.get_js_row_key(this$,"shortName");
if(cljs.core.truth_(temp__5802__auto__)){
var r = temp__5802__auto__;
var G__46434 = cljs.core.str.cljs$core$IFn$_invoke$arity$1(r);
switch (G__46434) {
case "CASH":
return ({"sx": ({"cursor": "pointer", "backgroundColor": "#e1ecf7"})});
...
var G__46435 = kdlyticsgui.mrttables.cell_value(cell);
switch (G__46435) {
case (0):
...
var G__46436 = kdlyticsgui.mrttables.cell_value(cell);
switch (G__46436) {
case "Y":
return ({"sx": ({"color": "Chartreuse", "backgroundColor": "Chartreuse", "textAlign": "center"})});
...
var G__46437 = kdlyticsgui.mrttables.cell_value(cell);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__46437)){
return ({"sx": ({"color": "Chartreuse", "backgroundColor": "Chartreuse", "textAlign": "center"})});
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__46437)){
return ({"sx": ({"color": "Crimson", "backgroundColor": "Crimson", "textAlign": "center"})});
} else {
return ({});
...
var pred__46438 = cljs.core._GT_;
var expr__46439 = kdlyticsgui.mrttables.cell_value(cell);
if(cljs.core.truth_((pred__46438.cljs$core$IFn$_invoke$arity$2 ? pred__46438.cljs$core$IFn$_invoke$arity$2((1),expr__46439) : pred__46438.call(null,(1),expr__46439)))){
return ({"sx": ({"color": "Chartreuse", "backgroundColor": "Chartreuse", "textAlign": "center"})});
} else {
if(cljs.core.truth_((pred__46438.cljs$core$IFn$_invoke$arity$2 ? pred__46438.cljs$core$IFn$_invoke$arity$2((10),expr__46439) : pred__46438.call(null,(10),expr__46439)))){
return ({"sx": ({"color": "DarkOrange", "backgroundColor": "DarkOrange", "textAlign": "center"})});
} else {
if(cljs.core.truth_((pred__46438.cljs$core$IFn$_invoke$arity$2 ? pred__46438.cljs$core$IFn$_invoke$arity$2((999),expr__46439) : pred__46438.call(null,(999),expr__46439)))){
return ({"sx": ({"color": "Crimson", "backgroundColor": "Crimson", "textAlign": "center"})});
} else {
...
return kdlyticsgui.mrttables.median(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46441_SHARP_){
return p1__46441_SHARP_.getValue(columnId);
}),leafRows));
});
...
kdlyticsgui.mrttables.round0 = (function kdlyticsgui$mrttables$round0(p1__46442_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.0f",1.0,p1__46442_SHARP_);
});
kdlyticsgui.mrttables.round1 = (function kdlyticsgui$mrttables$round1(p1__46443_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.1f",1.0,p1__46443_SHARP_);
});
kdlyticsgui.mrttables.round2 = (function kdlyticsgui$mrttables$round2(p1__46444_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.2f",1.0,p1__46444_SHARP_);
});
kdlyticsgui.mrttables.round0pc = (function kdlyticsgui$mrttables$round0pc(p1__46445_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.0f%",1.0,p1__46445_SHARP_);
});
kdlyticsgui.mrttables.round1pc = (function kdlyticsgui$mrttables$round1pc(p1__46446_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.1f%",1.0,p1__46446_SHARP_);
});
kdlyticsgui.mrttables.round2pc = (function kdlyticsgui$mrttables$round2pc(p1__46447_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.2f%",1.0,p1__46447_SHARP_);
});
kdlyticsgui.mrttables.round0pc100 = (function kdlyticsgui$mrttables$round0pc100(p1__46448_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.0f%",100.0,p1__46448_SHARP_);
});
kdlyticsgui.mrttables.round1pc100 = (function kdlyticsgui$mrttables$round1pc100(p1__46449_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.1f%",100.0,p1__46449_SHARP_);
});
kdlyticsgui.mrttables.round2pc100 = (function kdlyticsgui$mrttables$round2pc100(p1__46450_SHARP_){
return kdlyticsgui.mrttables.nb_cell_format("%.2f%",100.0,p1__46450_SHARP_);
});
/**
...
return line.split("&").every((function (p1__46452_SHARP_){
return kdlyticsgui.mrttables.lower_case_s_in_value_QMARK_(p1__46452_SHARP_,id);
}));
});
/**
...
return filterValue.toLowerCase().replaceAll(" ","").split(",").some((function (p1__46453_SHARP_){
...
var G__46456 = input.substring((0),(1));
switch (G__46456) {
case ">":
...
var compread = (function (p1__46457_SHARP_){
return kdlyticsgui.mrttables.comparator_read.cljs$core$IFn$_invoke$arity$2(row.getValue(id),p1__46457_SHARP_);
});
return filterValue.toLowerCase().split(",").some((function (p1__46458_SHARP_){
return kdlyticsgui.mrttables.ampersand_comp(compread,p1__46458_SHARP_);
}));
});
/**
...
kdlyticsgui.mrttables.icon_element_button_helix = (function (){var G__46466 = (function kdlyticsgui$mrttables$icon_element_button_helix_render(props__29210__auto__,maybe_ref__29211__auto__){
var vec__46467 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29210__auto__),maybe_ref__29211__auto__], null);
var map__46470 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46467,(0),null);
var map__46470__$1 = cljs.core.__destructure_map(map__46470);
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46470__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var tooltip_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46470__$1,new cljs.core.Keyword(null,"tooltip-text","tooltip-text",-2102487661));
var on_click_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46470__$1,new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852));

return helix.core.get_react().createElement(module$node_modules$$mui$material$node$index.Tooltip,(function (){var obj46472 = ({"arrow":true,"title":tooltip_text,"key":tooltip_text});
return obj46472;
})(),helix.core.get_react().createElement(module$node_modules$$mui$material$node$index.IconButton,(function (){var obj46474 = ({"onClick":on_click_fn});
return obj46474;
})(),helix.core.get_react().createElement(icon,null)));
});
if(goog.DEBUG === true){
var G__46475 = G__46466;
(G__46475.displayName = "kdlyticsgui.mrttables/icon-element-button-helix");
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function kdlyticsgui$mrttables$get_pivoted_data_$_iter__46476(s__46477){
return (new cljs.core.LazySeq(null,(function (){
var s__46477__$1 = s__46477;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__46477__$1);
if(temp__5804__auto__){
var s__46477__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46477__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__46477__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__46479 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__46478 = (0);
while(true){
if((i__46478 < size__5522__auto__)){
var leaf = cljs.core._nth(c__5521__auto__,i__46478);
cljs.core.chunk_append(b__46479,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(leaf._groupingValuesCache),"group",leaf.groupingValue));

var G__46630 = (i__46478 + (1));
i__46478 = G__46630;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46479),kdlyticsgui$mrttables$get_pivoted_data_$_iter__46476(cljs.core.chunk_rest(s__46477__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46479),null);
}
} else {
var leaf = cljs.core.first(s__46477__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(leaf._groupingValuesCache),"group",leaf.groupingValue),kdlyticsgui$mrttables$get_pivoted_data_$_iter__46476(cljs.core.rest(s__46477__$2)));
}
} else {
return null;
}
...
var dw_cols = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["group"], null),cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(table.getAllLeafColumns().filter((function (p1__46480_SHARP_){
return cljs.core.not(p1__46480_SHARP_.getIsGrouped());
})).map((function (p1__46481_SHARP_){
return p1__46481_SHARP_.id;
}))));
...
var G__46482 = table.getPrePaginationRowModel().rows.map((function (row){
return row.original;
}));
return (download_fn.cljs$core$IFn$_invoke$arity$1 ? download_fn.cljs$core$IFn$_invoke$arity$1(G__46482) : download_fn.call(null,G__46482));
}
});
 ...
 */
kdlyticsgui.mrttables.single_risk_table_toolbar = (function (){var G__46484 = (function kdlyticsgui$mrttables$single_risk_table_toolbar_render(props__29210__auto__,maybe_ref__29211__auto__){
var vec__46485 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29210__auto__),maybe_ref__29211__auto__], null);
var map__46488 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46485,(0),null);
var map__46488__$1 = cljs.core.__destructure_map(map__46488);
var table = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46488__$1,new cljs.core.Keyword(null,"table","table",-564943036));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46488__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var download_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46488__$1,new cljs.core.Keyword(null,"download-fn","download-fn",386504264));
var photo_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46488__$1,new cljs.core.Keyword(null,"photo-id","photo-id",108052797));

return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46490 = ({"key":"BarChart","icon":module$node_modules$$mui$icons_material$BarChart.default,"tooltip-text":"Bar chart","on-click-fn":(function (){
...
return obj46490;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46492 = ({"key":"PieChart","icon":module$node_modules$$mui$icons_material$PieChart.default,"tooltip-text":"Pie chart","on-click-fn":(function (){
...
return obj46492;
})()),helix.core.get_react().createElement(module$node_modules$$mui$material$node$index.Divider,(function (){var obj46494 = ({"key":"divider0","variant":"middle","orientation":"vertical"});
return obj46494;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46496 = ({"key":"Filter1Icon","icon":module$node_modules$$mui$icons_material$Filter1.default,"tooltip-text":"View 1","on-click-fn":(function (){
...
return obj46496;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46498 = ({"key":"Filter2Icon","icon":module$node_modules$$mui$icons_material$Filter2.default,"tooltip-text":"View 2","on-click-fn":(function (){
...
return obj46498;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46500 = ({"key":"Filter3Icon","icon":module$node_modules$$mui$icons_material$Filter3.default,"tooltip-text":"View 3","on-click-fn":(function (){
...
return obj46500;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46502 = ({"key":"Filter4Icon","icon":module$node_modules$$mui$icons_material$Filter4.default,"tooltip-text":"View 4","on-click-fn":(function (){
...
return obj46502;
})()),helix.core.get_react().createElement(module$node_modules$$mui$material$node$index.Divider,(function (){var obj46504 = ({"key":"divider1","variant":"middle","orientation":"vertical"});
return obj46504;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46506 = ({"key":"ExpandIcon","icon":module$node_modules$$mui$icons_material$Expand.default,"tooltip-text":"Show more rows","on-click-fn":(function (){
if((cljs.core.count(table.getState().grouping) > (0))){
...
return obj46506;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46508 = ({"key":"FilterListOffIcon","icon":module$node_modules$$mui$icons_material$FilterListOff.default,"tooltip-text":"Clear filters","on-click-fn":(function (){
return table.resetColumnFilters([]);
})});
return obj46508;
})()),helix.core.get_react().createElement(module$node_modules$material_react_table$dist$cjs$index.MRT_ShowHideColumnsButton,(function (){var obj46510 = ({"table":table,"key":"show-columns"});
return obj46510;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46512 = ({"key":"SystemUpdateAltIcon","icon":module$node_modules$$mui$icons_material$SystemUpdateAlt.default,"tooltip-text":"Download view","on-click-fn":(function (){
return kdlyticsgui.mrttables.download_view(table,download_fn,photo_id);
})});
return obj46512;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46514 = ({"key":"DownloadIcon","icon":module$node_modules$$mui$icons_material$Download.default,"tooltip-text":"Full download","on-click-fn":(function (){
...
if(goog.DEBUG === true){
var G__46515 = G__46484;
(G__46515.displayName = "kdlyticsgui.mrttables/single-risk-table-toolbar");
 ...
 * This returns the top right Toolbar function with the standard actions
 */
kdlyticsgui.mrttables.mrt_table_toolbar = (function (){var G__46517 = (function kdlyticsgui$mrttables$mrt_table_toolbar_render(props__29210__auto__,maybe_ref__29211__auto__){
var vec__46518 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29210__auto__),maybe_ref__29211__auto__], null);
var map__46521 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46518,(0),null);
var map__46521__$1 = cljs.core.__destructure_map(map__46521);
var table = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46521__$1,new cljs.core.Keyword(null,"table","table",-564943036));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46521__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var download_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46521__$1,new cljs.core.Keyword(null,"download-fn","download-fn",386504264));
var photo_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46521__$1,new cljs.core.Keyword(null,"photo-id","photo-id",108052797));

return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46523 = ({"key":"FilterListOffIcon","icon":module$node_modules$$mui$icons_material$FilterListOff.default,"tooltip-text":"Clear filters","on-click-fn":(function (){
return table.resetColumnFilters([]);
})});
return obj46523;
})()),helix.core.get_react().createElement(module$node_modules$material_react_table$dist$cjs$index.MRT_ShowHideColumnsButton,(function (){var obj46525 = ({"table":table,"key":"show-columns"});
return obj46525;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46527 = ({"key":"SystemUpdateAltIcon","icon":module$node_modules$$mui$icons_material$SystemUpdateAlt.default,"tooltip-text":"Download view","on-click-fn":(function (){
return kdlyticsgui.mrttables.download_view(table,download_fn,photo_id);
})});
return obj46527;
})()),helix.core.get_react().createElement(kdlyticsgui.mrttables.icon_element_button_helix,(function (){var obj46529 = ({"key":"DownloadIcon","icon":module$node_modules$$mui$icons_material$Download.default,"tooltip-text":"Full download","on-click-fn":(function (){
return (download_fn.cljs$core$IFn$_invoke$arity$1 ? download_fn.cljs$core$IFn$_invoke$arity$1(data) : download_fn.call(null,data));
})});
return obj46529;
})())], null);
...
if(goog.DEBUG === true){
var G__46530 = G__46517;
(G__46530.displayName = "kdlyticsgui.mrttables/mrt-table-toolbar");
...
var visible_ids = cljs.core.set(table.getVisibleLeafColumns().map((function (p1__46531_SHARP_){
return p1__46531_SHARP_.id;
})));
var group_visible_QMARK_ = clojure.set.subset_QMARK_(groupset,visible_ids);
if(group_visible_QMARK_){
var seq__46532 = cljs.core.seq(groupset);
var chunk__46533 = null;
var count__46534 = (0);
var i__46535 = (0);
while(true){
if((i__46535 < count__46534)){
var id = chunk__46533.cljs$core$IIndexed$_nth$arity$2(null,i__46535);
table.getColumn(id).toggleVisibility(false);


var G__46652 = seq__46532;
var G__46653 = chunk__46533;
var G__46654 = count__46534;
var G__46655 = (i__46535 + (1));
seq__46532 = G__46652;
chunk__46533 = G__46653;
count__46534 = G__46654;
i__46535 = G__46655;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__46532);
if(temp__5804__auto__){
var seq__46532__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__46532__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__46532__$1);
var G__46657 = cljs.core.chunk_rest(seq__46532__$1);
var G__46658 = c__5568__auto__;
var G__46659 = cljs.core.count(c__5568__auto__);
var G__46660 = (0);
seq__46532 = G__46657;
chunk__46533 = G__46658;
count__46534 = G__46659;
i__46535 = G__46660;
continue;
} else {
var id = cljs.core.first(seq__46532__$1);
table.getColumn(id).toggleVisibility(false);


var G__46661 = cljs.core.next(seq__46532__$1);
var G__46662 = null;
var G__46663 = (0);
var G__46664 = (0);
seq__46532 = G__46661;
chunk__46533 = G__46662;
count__46534 = G__46663;
i__46535 = G__46664;
continue;
}
} else {
...
var seq__46536 = cljs.core.seq(groupset);
var chunk__46537 = null;
var count__46538 = (0);
var i__46539 = (0);
while(true){
if((i__46539 < count__46538)){
var id = chunk__46537.cljs$core$IIndexed$_nth$arity$2(null,i__46539);
table.getColumn(id).toggleVisibility(true);


var G__46665 = seq__46536;
var G__46666 = chunk__46537;
var G__46667 = count__46538;
var G__46668 = (i__46539 + (1));
seq__46536 = G__46665;
chunk__46537 = G__46666;
count__46538 = G__46667;
i__46539 = G__46668;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__46536);
if(temp__5804__auto__){
var seq__46536__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__46536__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__46536__$1);
var G__46669 = cljs.core.chunk_rest(seq__46536__$1);
var G__46670 = c__5568__auto__;
var G__46671 = cljs.core.count(c__5568__auto__);
var G__46672 = (0);
seq__46536 = G__46669;
chunk__46537 = G__46670;
count__46538 = G__46671;
i__46539 = G__46672;
continue;
} else {
var id = cljs.core.first(seq__46536__$1);
table.getColumn(id).toggleVisibility(true);


var G__46673 = cljs.core.next(seq__46536__$1);
var G__46674 = null;
var G__46675 = (0);
var G__46676 = (0);
seq__46536 = G__46673;
chunk__46537 = G__46674;
count__46538 = G__46675;
i__46539 = G__46676;
continue;
}
} else {
...
})(),(function (){var obj46541 = ({"table":x.table,"data":mdata,"download-fn":(function (){var or__5045__auto__ = download_fn;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
 ...
 *   
 */
kdlyticsgui.mrttables.material_react_table_template = (function (){var G__46545 = (function kdlyticsgui$mrttables$material_react_table_template_render(props__29210__auto__,maybe_ref__29211__auto__){
var vec__46546 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29210__auto__),maybe_ref__29211__auto__], null);
var map__46549 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46546,(0),null);
var map__46549__$1 = cljs.core.__destructure_map(map__46549);
var clj_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"clj-columns","clj-columns",678745596));
var photo_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"photo-id","photo-id",108052797));
var external_state_reference = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"external-state-reference","external-state-reference",-1421880032));
var initial_external_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"initial-external-state","initial-external-state",690996258));
var download_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"download-fn","download-fn",386504264));
var clj_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"clj-data","clj-data",-774432148));
var clj_option_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"clj-option-map","clj-option-map",1277941618));
var toolbar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"toolbar","toolbar",-1172789065));
var js_initial_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"js-initial-state","js-initial-state",234739608));
...
var vec__46550 = helix.hooks.use_state(initial_external_state.columnFilters);
var ffilter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46550,(0),null);
var setFilter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46550,(1),null);
var vec__46553 = helix.hooks.use_state(initial_external_state.grouping);
var grouping = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46553,(0),null);
var setGrouping = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46553,(1),null);
var vec__46556 = helix.hooks.use_state(initial_external_state.expanded);
var expanded = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46556,(0),null);
var setExpanded = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46556,(1),null);
var mdata = (function (){var G__46559 = (function (){
...
clj_data.forEach((function (p1__46542_SHARP_){
return (p1__46542_SHARP_["dummy"] = "");
}));
} else {
}
...
return cljs.core.clj__GT_js((cljs.core.truth_(new cljs.core.Keyword(null,"enableGrouping","enableGrouping",1673342785).cljs$core$IFn$_invoke$arity$1(clj_option_map))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46543_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46543_SHARP_,new cljs.core.Keyword(null,"dummy","dummy",2059765854),"");
}),clj_data):clj_data));
}
});
var G__46560 = [clj_data,clj_option_map];
return (helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2(G__46559,G__46560) : helix.hooks.raw_use_memo.call(null,G__46559,G__46560));
})();
var mcolumns = (function (){var G__46561 = (function (){
return cljs.core.clj__GT_js(clj_columns);
});
var G__46562 = [clj_columns];
return (helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2(G__46561,G__46562) : helix.hooks.raw_use_memo.call(null,G__46561,G__46562));
})();
var x = (function (){var G__46563 = helix.hooks.wrap_fx((function (){
...
var G__46564 = [ffilter,grouping,expanded];
return (helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2(G__46563,G__46564) : helix.hooks.raw_use_effect.call(null,G__46563,G__46564));
})();
...
return helix.core.get_react().createElement("div",(function (){var obj46566 = ({"id":photo_id});
return obj46566;
...
if(goog.DEBUG === true){
var G__46569 = G__46545;
(G__46569.displayName = "kdlyticsgui.mrttables/material-react-table-template");
 ...
 *   Note you need to add extra key with a dummy value that changes every time you want full re-render!!!
 */
kdlyticsgui.mrttables.material_react_table_template_fast = (function (){var G__46573 = (function kdlyticsgui$mrttables$material_react_table_template_fast_render(props__29210__auto__,maybe_ref__29211__auto__){
var vec__46574 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29210__auto__),maybe_ref__29211__auto__], null);
var map__46577 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46574,(0),null);
var map__46577__$1 = cljs.core.__destructure_map(map__46577);
var clj_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"clj-data","clj-data",-774432148));
var clj_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"clj-columns","clj-columns",678745596));
var clj_option_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"clj-option-map","clj-option-map",1277941618));
var js_initial_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"js-initial-state","js-initial-state",234739608));
var toolbar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"toolbar","toolbar",-1172789065));
var download_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"download-fn","download-fn",386504264));
var photo_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46577__$1,new cljs.core.Keyword(null,"photo-id","photo-id",108052797));

var pinned_cols = cljs.core.clj__GT_js(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"accessorKey","accessorKey",-1383292807),new cljs.core.Keyword(null,"columns","columns",1998437288).cljs$core$IFn$_invoke$arity$1(cljs.core.first(clj_columns))),"mrt-row-expand"));
var mdata = (function (){var G__46578 = (function (){
if(cljs.core.array_QMARK_(clj_data)){
if(cljs.core.truth_(new cljs.core.Keyword(null,"enableGrouping","enableGrouping",1673342785).cljs$core$IFn$_invoke$arity$1(clj_option_map))){
clj_data.forEach((function (p1__46570_SHARP_){
return (p1__46570_SHARP_["dummy"] = "");
}));
} else {
}
...
return cljs.core.clj__GT_js((cljs.core.truth_(new cljs.core.Keyword(null,"enableGrouping","enableGrouping",1673342785).cljs$core$IFn$_invoke$arity$1(clj_option_map))?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46571_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46571_SHARP_,new cljs.core.Keyword(null,"dummy","dummy",2059765854),"");
}),clj_data):clj_data));
}
});
var G__46579 = [clj_data,clj_option_map];
return (helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2(G__46578,G__46579) : helix.hooks.raw_use_memo.call(null,G__46578,G__46579));
})();
var mcolumns = (function (){var G__46580 = (function (){
return cljs.core.clj__GT_js(clj_columns);
});
var G__46581 = [clj_columns];
return (helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_memo.cljs$core$IFn$_invoke$arity$2(G__46580,G__46581) : helix.hooks.raw_use_memo.call(null,G__46580,G__46581));
})();
...
return helix.core.get_react().createElement("div",(function (){var obj46583 = ({"id":photo_id});
return obj46583;
})(),helix.core.get_react().createElement(module$node_modules$material_react_table$dist$cjs$index.default,helix.impl.props.merge_obj(({}),helix.impl.props._props.cljs$core$IFn$_invoke$arity$1(props))));
});
if(goog.DEBUG === true){
var G__46586 = G__46573;
(G__46586.displayName = "kdlyticsgui.mrttables/material-react-table-template-fast");
...
kdlyticsgui.mrttables.material_react_table_template_basic = (function (){var G__46589 = (function kdlyticsgui$mrttables$material_react_table_template_basic_render(props__29210__auto__,maybe_ref__29211__auto__){
var vec__46590 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29210__auto__),maybe_ref__29211__auto__], null);
var argument_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46590,(0),null);

return helix.core.get_react().createElement(kdlyticsgui.mrttables.material_react_table_template_fast,helix.impl.props.merge_obj(({}),helix.impl.props._props.cljs$core$IFn$_invoke$arity$1(cljs.core.update.cljs$core$IFn$_invoke$arity$3(argument_map,new cljs.core.Keyword(null,"clj-option-map","clj-option-map",1277941618),(function (p1__46587_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"enablePagination","enablePagination",594938512),false,new cljs.core.Keyword(null,"enableBottomToolbar","enableBottomToolbar",-255865294),false], null),p1__46587_SHARP_], 0));
})))));
});
if(goog.DEBUG === true){
var G__46595 = G__46589;
(G__46595.displayName = "kdlyticsgui.mrttables/material-react-table-template-basic");
