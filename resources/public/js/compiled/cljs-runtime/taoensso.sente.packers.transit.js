...
var e_58616 = (function (){try{if((function (){var fexpr__58606 = (function (x){
return cljs.core.contains_QMARK_((function (){var G__58607 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"json","json",1279968570),null], null), null);
return (taoensso.truss.impl.set_STAR_.cljs$core$IFn$_invoke$arity$1 ? taoensso.truss.impl.set_STAR_.cljs$core$IFn$_invoke$arity$1(G__58607) : taoensso.truss.impl.set_STAR_.call(null,G__58607));
})(),x);
});
return fexpr__58606(transit_fmt);
})()){
return null;
} else {
return taoensso.truss.impl._dummy_error;
}
}catch (e58604){if((e58604 instanceof Error)){
var e = e58604;
return e;
} else {
throw e58604;
...
taoensso.truss.impl._invar_violation_BANG_(true,"taoensso.sente.packers.transit",102,"([:el #{:json}] transit-fmt)",transit_fmt,e_58616,null);
}
...
}catch (e58610){if((e58610 instanceof Error)){
var e = e58610;
return e;
} else {
throw e58610;
...
}catch (e58613){if((e58613 instanceof Error)){
var e = e58613;
return e;
} else {
throw e58613;
