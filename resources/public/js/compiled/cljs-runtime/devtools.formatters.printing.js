...
var len__5769__auto___29947 = arguments.length;
var i__5770__auto___29950 = (0);
while(true){
if((i__5770__auto___29950 < len__5769__auto___29947)){
args__5775__auto__.push((arguments[i__5770__auto___29950]));

var G__29951 = (i__5770__auto___29950 + (1));
i__5770__auto___29950 = G__29951;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29848){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29878_SHARP_){
return (!((cljs.core.meta(p1__29878_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29897__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29898){var _e__28293__auto__ = e29898;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e29900){var _e__28293__auto__ = e29900;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29902 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29903 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29903);
...
var map__29904 = opts;
var map__29904__$1 = cljs.core.__destructure_map(map__29904);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29904__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29902);
}});
...
var temp__5802__auto___29962 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___29962)){
var managed_print_level_29963 = temp__5802__auto___29962;
var _STAR_print_level_STAR__orig_val__29930_29964 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29931_29965 = managed_print_level_29963;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29931_29965);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29905_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29905_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29930_29964);
}} else {
job_fn();
}
