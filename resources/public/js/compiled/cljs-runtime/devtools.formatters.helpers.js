...
var G__45788 = devtools.prefs.pref(v);
v = G__45788;
continue;
} else {
return v;
...
}catch (e45769){var _e__41440__auto__ = e45769;
return false;
}})();
...
}catch (e45773){var _e__41440__auto__ = e45773;
return false;
}})();
...
}catch (e45775){var _e__41440__auto__ = e45775;
return false;
}}
}
});
...
var vec__45781 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45781,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45781,(1),null);
...
return cljs.core.some((function (p1__45784_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__45784_SHARP_);
}),template);
});
