...
var G__29746 = devtools.prefs.pref(v);
v = G__29746;
continue;
} else {
return v;
...
}catch (e29583){var _e__28293__auto__ = e29583;
return false;
}})();
...
}catch (e29585){var _e__28293__auto__ = e29585;
return false;
}})();
...
}catch (e29587){var _e__28293__auto__ = e29587;
return false;
}}
}
});
...
var vec__29654 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29654,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29654,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29711_SHARP_);
}),template);
});
