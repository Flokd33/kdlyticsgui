...
var G__45141 = devtools.prefs.pref(v);
v = G__45141;
continue;
} else {
return v;
...
}catch (e45071){var _e__41754__auto__ = e45071;
return false;
}})();
...
}catch (e45082){var _e__41754__auto__ = e45082;
return false;
}})();
...
}catch (e45086){var _e__41754__auto__ = e45086;
return false;
}}
}
});
...
var vec__45106 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45106,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45106,(1),null);
...
return cljs.core.some((function (p1__45113_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__45113_SHARP_);
}),template);
});
