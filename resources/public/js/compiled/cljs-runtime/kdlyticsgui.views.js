...
var seq__30344_30360 = cljs.core.seq(new cljs.core.Keyword(null,"load-events","load-events",851978219).cljs$core$IFn$_invoke$arity$1(item));
var chunk__30345_30361 = null;
var count__30346_30362 = (0);
var i__30347_30363 = (0);
while(true){
if((i__30347_30363 < count__30346_30362)){
var k_30364 = chunk__30345_30361.cljs$core$IIndexed$_nth$arity$2(null,i__30347_30363);
re_frame.core.dispatch(((cljs.core.vector_QMARK_(k_30364))?k_30364:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k_30364], null)));


var G__30365 = seq__30344_30360;
var G__30366 = chunk__30345_30361;
var G__30367 = count__30346_30362;
var G__30368 = (i__30347_30363 + (1));
seq__30344_30360 = G__30365;
chunk__30345_30361 = G__30366;
count__30346_30362 = G__30367;
i__30347_30363 = G__30368;
continue;
} else {
var temp__5804__auto___30369 = cljs.core.seq(seq__30344_30360);
if(temp__5804__auto___30369){
var seq__30344_30370__$1 = temp__5804__auto___30369;
if(cljs.core.chunked_seq_QMARK_(seq__30344_30370__$1)){
var c__5568__auto___30371 = cljs.core.chunk_first(seq__30344_30370__$1);
var G__30372 = cljs.core.chunk_rest(seq__30344_30370__$1);
var G__30373 = c__5568__auto___30371;
var G__30374 = cljs.core.count(c__5568__auto___30371);
var G__30375 = (0);
seq__30344_30360 = G__30372;
chunk__30345_30361 = G__30373;
count__30346_30362 = G__30374;
i__30347_30363 = G__30375;
continue;
} else {
var k_30376 = cljs.core.first(seq__30344_30370__$1);
re_frame.core.dispatch(((cljs.core.vector_QMARK_(k_30376))?k_30376:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k_30376], null)));


var G__30377 = cljs.core.next(seq__30344_30370__$1);
var G__30378 = null;
var G__30379 = (0);
var G__30380 = (0);
seq__30344_30360 = G__30377;
chunk__30345_30361 = G__30378;
count__30346_30362 = G__30379;
i__30347_30363 = G__30380;
continue;
}
} else {
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30351),kdlyticsgui$views$top_nav_bar_$_iter__30348(cljs.core.chunk_rest(s__30349__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30351),null);
}
} else {
var item = cljs.core.first(s__30349__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"width","width",-384071477),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"wealth","wealth",-1566112704)))?"150px":"150px"),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_view,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?"dropdown-active":"dropdown"),new cljs.core.Keyword(null,"child","child",623967545),(cljs.core.truth_(new cljs.core.Keyword(null,"href","href",-793805698).cljs$core$IFn$_invoke$arity$1(item))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.hyperlink_href,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"href","href",-793805698),new cljs.core.Keyword(null,"href","href",-793805698).cljs$core$IFn$_invoke$arity$1(item)], null):new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.hyperlink,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__30349__$2,temp__5804__auto__,active_view){
return (function (){
return kdlyticsgui.views.navigation_event(item);
});})(item,s__30349__$2,temp__5804__auto__,active_view))
], null))], null),kdlyticsgui$views$top_nav_bar_$_iter__30348(cljs.core.rest(s__30349__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"20px",new cljs.core.Keyword(null,"class","class",-2030961996),"leftnavbar",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function kdlyticsgui$views$left_nav_bar_$_iter__30352(s__30353){
return (new cljs.core.LazySeq(null,(function (){
var s__30353__$1 = s__30353;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__30353__$1);
if(temp__5804__auto__){
var s__30353__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30353__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__30353__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__30355 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__30354 = (0);
while(true){
if((i__30354 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__30354);
cljs.core.chunk_append(b__30355,cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key], null))),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__30354,item,c__5521__auto__,size__5522__auto__,b__30355,s__30353__$2,temp__5804__auto__){
return (function (){
...
});})(i__30354,item,c__5521__auto__,size__5522__auto__,b__30355,s__30353__$2,temp__5804__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)));

var G__30382 = (i__30354 + (1));
i__30354 = G__30382;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30355),kdlyticsgui$views$left_nav_bar_$_iter__30352(cljs.core.chunk_rest(s__30353__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30355),null);
}
} else {
var item = cljs.core.first(s__30353__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key], null))),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__30353__$2,temp__5804__auto__){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null));
});})(item,s__30353__$2,temp__5804__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)),kdlyticsgui$views$left_nav_bar_$_iter__30352(cljs.core.rest(s__30353__$2)));
}
} else {
return null;
}
...
var G__30359 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-section","navigation/active-section",-1272053018)], null)));
var G__30359__$1 = (((G__30359 instanceof cljs.core.Keyword))?G__30359.fqn:null);
switch (G__30359__$1) {
case "entry":
