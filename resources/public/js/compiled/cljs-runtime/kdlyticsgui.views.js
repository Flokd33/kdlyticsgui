...
var seq__45652_45666 = cljs.core.seq(new cljs.core.Keyword(null,"load-events","load-events",851978219).cljs$core$IFn$_invoke$arity$1(item));
var chunk__45653_45667 = null;
var count__45654_45668 = (0);
var i__45655_45669 = (0);
while(true){
if((i__45655_45669 < count__45654_45668)){
var k_45670 = chunk__45653_45667.cljs$core$IIndexed$_nth$arity$2(null,i__45655_45669);
re_frame.core.dispatch(((cljs.core.vector_QMARK_(k_45670))?k_45670:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k_45670], null)));


var G__45671 = seq__45652_45666;
var G__45672 = chunk__45653_45667;
var G__45673 = count__45654_45668;
var G__45674 = (i__45655_45669 + (1));
seq__45652_45666 = G__45671;
chunk__45653_45667 = G__45672;
count__45654_45668 = G__45673;
i__45655_45669 = G__45674;
continue;
} else {
var temp__5804__auto___45675 = cljs.core.seq(seq__45652_45666);
if(temp__5804__auto___45675){
var seq__45652_45676__$1 = temp__5804__auto___45675;
if(cljs.core.chunked_seq_QMARK_(seq__45652_45676__$1)){
var c__5568__auto___45677 = cljs.core.chunk_first(seq__45652_45676__$1);
var G__45678 = cljs.core.chunk_rest(seq__45652_45676__$1);
var G__45679 = c__5568__auto___45677;
var G__45680 = cljs.core.count(c__5568__auto___45677);
var G__45681 = (0);
seq__45652_45666 = G__45678;
chunk__45653_45667 = G__45679;
count__45654_45668 = G__45680;
i__45655_45669 = G__45681;
continue;
} else {
var k_45682 = cljs.core.first(seq__45652_45676__$1);
re_frame.core.dispatch(((cljs.core.vector_QMARK_(k_45682))?k_45682:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k_45682], null)));


var G__45683 = cljs.core.next(seq__45652_45676__$1);
var G__45684 = null;
var G__45685 = (0);
var G__45686 = (0);
seq__45652_45666 = G__45683;
chunk__45653_45667 = G__45684;
count__45654_45668 = G__45685;
i__45655_45669 = G__45686;
continue;
}
} else {
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45659),kdlyticsgui$views$top_nav_bar_$_iter__45656(cljs.core.chunk_rest(s__45657__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45659),null);
}
} else {
var item = cljs.core.first(s__45657__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"width","width",-384071477),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"wealth","wealth",-1566112704)))?"175px":"150px"),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_view,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?"dropdown-active":"dropdown"),new cljs.core.Keyword(null,"child","child",623967545),(cljs.core.truth_(new cljs.core.Keyword(null,"href","href",-793805698).cljs$core$IFn$_invoke$arity$1(item))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.hyperlink_href,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"href","href",-793805698),new cljs.core.Keyword(null,"href","href",-793805698).cljs$core$IFn$_invoke$arity$1(item)], null):new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.hyperlink,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__45657__$2,temp__5804__auto__,active_view){
return (function (){
return kdlyticsgui.views.navigation_event(item);
});})(item,s__45657__$2,temp__5804__auto__,active_view))
], null))], null),kdlyticsgui$views$top_nav_bar_$_iter__45656(cljs.core.rest(s__45657__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"20px",new cljs.core.Keyword(null,"class","class",-2030961996),"leftnavbar",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function kdlyticsgui$views$left_nav_bar_$_iter__45660(s__45661){
return (new cljs.core.LazySeq(null,(function (){
var s__45661__$1 = s__45661;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__45661__$1);
if(temp__5804__auto__){
var s__45661__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45661__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__45661__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__45663 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__45662 = (0);
while(true){
if((i__45662 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__45662);
cljs.core.chunk_append(b__45663,cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key], null))),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__45662,item,c__5521__auto__,size__5522__auto__,b__45663,s__45661__$2,temp__5804__auto__){
return (function (){
...
});})(i__45662,item,c__5521__auto__,size__5522__auto__,b__45663,s__45661__$2,temp__5804__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)));

var G__45688 = (i__45662 + (1));
i__45662 = G__45688;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45663),kdlyticsgui$views$left_nav_bar_$_iter__45660(cljs.core.chunk_rest(s__45661__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45663),null);
}
} else {
var item = cljs.core.first(s__45661__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key], null))),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__45661__$2,temp__5804__auto__){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null));
});})(item,s__45661__$2,temp__5804__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)),kdlyticsgui$views$left_nav_bar_$_iter__45660(cljs.core.rest(s__45661__$2)));
}
} else {
return null;
}
...
var G__45665 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-section","navigation/active-section",-1272053018)], null)));
