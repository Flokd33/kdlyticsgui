...
var len__5769__auto___29033 = arguments.length;
var i__5770__auto___29034 = (0);
while(true){
if((i__5770__auto___29034 < len__5769__auto___29033)){
args__5775__auto__.push((arguments[i__5770__auto___29034]));

var G__29035 = (i__5770__auto___29034 + (1));
i__5770__auto___29034 = G__29035;
continue;
} else {
}
break;
...
while(true){
if((i__5770__auto___29041 < len__5769__auto___29039)){
args__5775__auto__.push((arguments[i__5770__auto___29041]));

var G__29043 = (i__5770__auto___29041 + (1));
i__5770__auto___29041 = G__29043;
continue;
} else {
}
break;
...
var G__28864_29051 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__28864_29051) : set_filter_text.call(null,G__28864_29051));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__28865_SHARP_){
var node = reagent.dom.dom_node(p1__28865_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__28866_SHARP_){
var node = reagent.dom.dom_node(p1__28866_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__28873 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"id-fn","id-fn",316222798),id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__28873) : label_fn.call(null,G__28873));
})():placeholder);
...
var ins_SINGLEQUOTE_ = (function (){var G__28875 = ins;
...
return re_com.dropdown.capitalize_first_letter(G__28875);
} else {
return G__28875;
}
})();
...
var map__28880 = auto_complete_ret;
var map__28880__$1 = cljs.core.__destructure_map(map__28880);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28880__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28880__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28880__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
...
var ins_29053 = event.key;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(ins_29053),(1))){
re_com.dropdown.handle_free_text_insertion(event,ins_29053,auto_complete_QMARK_,capitalize_QMARK_,choices,internal_model,free_text_sel_range,free_text_change);
} else {
}

return null;
}),placeholder,disabled_QMARK_,(function (p1__28884_SHARP_){
return cljs.core.reset_BANG_(free_text_input,p1__28884_SHARP_);
}),(function (event){
...
var ins_29054 = event.clipboardData.getData("Text");
re_com.dropdown.handle_free_text_insertion(event,ins_29054,auto_complete_QMARK_,capitalize_QMARK_,choices,internal_model,free_text_sel_range,free_text_change);
...
var value_29055 = event.target.value;
var G__28889_29056 = (function (){var G__28890 = value_29055;
if(cljs.core.truth_(capitalize_QMARK_)){
return re_com.dropdown.capitalize_first_letter(G__28890);
} else {
return G__28890;
}
})();
(free_text_change.cljs$core$IFn$_invoke$arity$1 ? free_text_change.cljs$core$IFn$_invoke$arity$1(G__28889_29056) : free_text_change.call(null,G__28889_29056));
...
var vec__28896 = reagent.core.argv(p1__28895_SHARP_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28896,(0),null);
var free_text_input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28896,(1),null);
var select_free_text_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28896,(2),null);
var free_text_focused_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28896,(3),null);
var free_text_sel_range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28896,(4),null);
...
var callback = (function (p__28908){
var map__28909 = p__28908;
var map__28909__$1 = cljs.core.__destructure_map(map__28909);
var args = map__28909__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28909__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28909__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
var G__28911 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"filter-text","filter-text",-381699202),text,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668),regex_filter_QMARK_], null);
var G__28912 = (function (p1__28905_SHARP_){
...
var G__28913 = (function (p1__28907_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__28907_SHARP_], null));
});
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__28911,G__28912,G__28913) : choices.call(null,G__28911,G__28912,G__28913));
});
/**
...
var temp__5804__auto___29085 = new cljs.core.Keyword(null,"timer","timer",-1266967739).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__5804__auto___29085)){
var timer_29086 = temp__5804__auto___29085;
clearTimeout(timer_29086);
} else {
}
...
var args__5775__auto__ = [];
var len__5769__auto___29163 = arguments.length;
var i__5770__auto___29164 = (0);
while(true){
if((i__5770__auto___29164 < len__5769__auto___29163)){
args__5775__auto__.push((arguments[i__5770__auto___29164]));

var G__29165 = (i__5770__auto___29164 + (1));
i__5770__auto___29164 = G__29165;
continue;
} else {
}
break;
...
(re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__28951){
var map__28952 = p__28951;
var map__28952__$1 = cljs.core.__destructure_map(map__28952);
var args = map__28952__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28952__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28952__$1,new cljs.core.Keyword(null,"model","model",331153215));
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28952__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28952__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982),(250));
var just_drop_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28952__$1,new cljs.core.Keyword(null,"just-drop?","just-drop?",-378249297));
...
var set_filter_text = (function (text,p__28957,debounce_QMARK_){
...
var G__28965 = cljs.core.deref(internal_model);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__28965) : on_change.call(null,G__28965));
} else {
return null;
}
});
var callback = (function (p1__28929_SHARP_){
cljs.core.reset_BANG_(internal_model,(function (){var G__28969 = p1__28929_SHARP_;
...
var current_drop_showing_QMARK__29198 = cljs.core.deref(drop_showing_QMARK_);
if(cljs.core.truth_(current_drop_showing_QMARK__29198)){
focus_free_text();
} else {
}
...
cljs.core.reset_BANG_(drop_showing_QMARK_,cljs.core.not(current_drop_showing_QMARK__29198));
}
...
var free_text_change = (function (p1__28930_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__28930_SHARP_);
...
var drop_was_showing_QMARK__29221 = cljs.core.deref(drop_showing_QMARK_);
call_on_change();
...
if(cljs.core.truth_((function (){var and__5043__auto__ = drop_was_showing_QMARK__29221;
if(cljs.core.truth_(and__5043__auto__)){
...
var key_handler = (function (p1__28933_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__28982 = p1__28933_SHARP_.which;
switch (G__28982) {
case (13):
return press_enter();
...
break;
case (9):
return press_tab(p1__28933_SHARP_.shiftKey);
...
})())?new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.filter_text_box,filter_box_QMARK_,filter_text,key_handler,drop_showing_QMARK_,(function (p1__28938_SHARP_){
return set_filter_text(p1__28938_SHARP_,args__$1,true);
...
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["error rc-dropdown-choices-error ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"class","class",-2030961996)], null)))].join(''),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"style","style",-496642736)], null),cljs.core.PersistentArrayMap.EMPTY)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0)),new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__29003 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29003,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29003,(1),null);
...
var make_choices = (function (p1__28939_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__28939_SHARP_);
});
...
var ___$2 = (cljs.core.truth_(on_drop)?cljs.core.add_watch(drop_showing_QMARK_,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491),(function (p1__28942_SHARP_,p2__28943_SHARP_,p3__28940_SHARP_,p4__28941_SHARP_){
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.not(p3__28940_SHARP_);
if(and__5043__auto__){
return p4__28941_SHARP_;
} else {
return and__5043__auto__;
}
})())){
...
while (G__29293__i < G__29293__a.length) {G__29293__a[G__29293__i] = arguments[G__29293__i + 0]; ++G__29293__i;}
  p__28963 = new cljs.core.IndexedSeq(G__29293__a,0,null);
} 
...
re_com$dropdown$single_dropdown_render.cljs$lang$applyTo = (function (arglist__29296){
var p__28963 = cljs.core.seq(arglist__29296);
...
/** @this {Function} */
(re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq28944){
var self__5755__auto__ = this;
