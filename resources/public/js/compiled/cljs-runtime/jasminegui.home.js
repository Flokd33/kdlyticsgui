...
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__49209);
cljs.core.chunk_append(b__49210,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__49209,item,c__4527__auto__,size__4528__auto__,b__49210,s__49208__$2,temp__5735__auto__,active_home){
return (function (){
var G__49211 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
...
});})(i__49209,item,c__4527__auto__,size__4528__auto__,b__49210,s__49208__$2,temp__5735__auto__,active_home))
], null));

var G__49217 = (i__49209 + (1));
i__49209 = G__49217;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49210),jasminegui$home$nav_home_bar_$_iter__49207(cljs.core.chunk_rest(s__49208__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49210),null);
}
} else {
var item = cljs.core.first(s__49208__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__49208__$2,temp__5735__auto__,active_home){
return (function (){
var G__49212 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49212) : re_frame.core.dispatch.call(null,G__49212));
});})(item,s__49208__$2,temp__5735__auto__,active_home))
], null),jasminegui$home$nav_home_bar_$_iter__49207(cljs.core.rest(s__49208__$2)));
}
} else {
return null;
}
...
var active_home = cljs.core.deref((function (){var G__49214 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148)], null);
...
var G__49215 = active_home;
var G__49215__$1 = (((G__49215 instanceof cljs.core.Keyword))?G__49215.fqn:null);
switch (G__49215__$1) {
case "summary":
