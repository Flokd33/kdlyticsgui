...
var c__4527__auto__ = cljs.core.chunk_first(s__56255__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__56257 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__56256 = (0);
while(true){
if((i__56256 < size__4528__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__56256);
cljs.core.chunk_append(b__56257,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__56256,item,c__4527__auto__,size__4528__auto__,b__56257,s__56255__$2,temp__5735__auto__,active_home){
return (function (){
var G__56258 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-home","active-home",53621216),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__56258) : re_frame.core.dispatch.call(null,G__56258));
});})(i__56256,item,c__4527__auto__,size__4528__auto__,b__56257,s__56255__$2,temp__5735__auto__,active_home))
], null));

var G__56268 = (i__56256 + (1));
i__56256 = G__56268;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56257),jasminegui$home$nav_home_bar_$_iter__56254(cljs.core.chunk_rest(s__56255__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56257),null);
}
} else {
var item = cljs.core.first(s__56255__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__56255__$2,temp__5735__auto__,active_home){
return (function (){
var G__56259 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-home","active-home",53621216),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__56259) : re_frame.core.dispatch.call(null,G__56259));
});})(item,s__56255__$2,temp__5735__auto__,active_home))
], null),jasminegui$home$nav_home_bar_$_iter__56254(cljs.core.rest(s__56255__$2)));
}
} else {
return null;
}
...
var active_home = cljs.core.deref((function (){var G__56260 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-home","active-home",53621216)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__56260) : re_frame.core.subscribe.call(null,G__56260));
})());
window.scrollTo((0),(0));

var G__56261 = active_home;
