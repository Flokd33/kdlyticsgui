...
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__47079);
cljs.core.chunk_append(b__47080,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__47079,item,c__4527__auto__,size__4528__auto__,b__47080,s__47078__$2,temp__5735__auto__,active_home){
return (function (){
var G__47097 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__47097) : re_frame.core.dispatch.call(null,G__47097));
});})(i__47079,item,c__4527__auto__,size__4528__auto__,b__47080,s__47078__$2,temp__5735__auto__,active_home))
], null));

var G__47127 = (i__47079 + (1));
i__47079 = G__47127;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47080),jasminegui$home$nav_home_bar_$_iter__47077(cljs.core.chunk_rest(s__47078__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47080),null);
}
} else {
var item = cljs.core.first(s__47078__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__47078__$2,temp__5735__auto__,active_home){
return (function (){
var G__47103 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
...
});})(item,s__47078__$2,temp__5735__auto__,active_home))
], null),jasminegui$home$nav_home_bar_$_iter__47077(cljs.core.rest(s__47078__$2)));
}
} else {
return null;
}
...
var active_home = cljs.core.deref((function (){var G__47110 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148)], null);
