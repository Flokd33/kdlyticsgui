...
var active_home = cljs.core.deref((function (){var G__44881 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__44881) : re_frame.core.subscribe.call(null,G__44881));
})());
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([active_home], 0));

return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"20px",new cljs.core.Keyword(null,"class","class",-2030961996),"leftnavbar",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__4529__auto__ = (function jasminegui$home$nav_home_bar_$_iter__44882(s__44883){
return (new cljs.core.LazySeq(null,(function (){
var s__44883__$1 = s__44883;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__44883__$1);
if(temp__5735__auto__){
var s__44883__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__44883__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__44883__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__44885 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__44884 = (0);
while(true){
if((i__44884 < size__4528__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__44884);
cljs.core.chunk_append(b__44885,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__44884,item,c__4527__auto__,size__4528__auto__,b__44885,s__44883__$2,temp__5735__auto__,active_home){
return (function (){
var G__44886 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__44886) : re_frame.core.dispatch.call(null,G__44886));
});})(i__44884,item,c__4527__auto__,size__4528__auto__,b__44885,s__44883__$2,temp__5735__auto__,active_home))
], null));

var G__44907 = (i__44884 + (1));
i__44884 = G__44907;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44885),jasminegui$home$nav_home_bar_$_iter__44882(cljs.core.chunk_rest(s__44883__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44885),null);
}
} else {
var item = cljs.core.first(s__44883__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__44883__$2,temp__5735__auto__,active_home){
return (function (){
var G__44893 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__44893) : re_frame.core.dispatch.call(null,G__44893));
});})(item,s__44883__$2,temp__5735__auto__,active_home))
], null),jasminegui$home$nav_home_bar_$_iter__44882(cljs.core.rest(s__44883__$2)));
}
} else {
return null;
}
...
var active_home = cljs.core.deref((function (){var G__44900 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("navigation","active-home","navigation/active-home",1949576148)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__44900) : re_frame.core.subscribe.call(null,G__44900));
})());
window.scrollTo((0),(0));

var G__44901 = active_home;
