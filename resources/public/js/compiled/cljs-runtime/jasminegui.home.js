...
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__47263);
cljs.core.chunk_append(b__47264,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__47263,item,c__4527__auto__,size__4528__auto__,b__47264,s__47262__$2,temp__5735__auto__,active_home){
return (function (){
var G__47267 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-home","active-home",53621216),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__47267) : re_frame.core.dispatch.call(null,G__47267));
});})(i__47263,item,c__4527__auto__,size__4528__auto__,b__47264,s__47262__$2,temp__5735__auto__,active_home))
], null));

var G__47278 = (i__47263 + (1));
i__47263 = G__47278;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47264),jasminegui$home$nav_home_bar_$_iter__47261(cljs.core.chunk_rest(s__47262__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47264),null);
}
} else {
var item = cljs.core.first(s__47262__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_home,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__47262__$2,temp__5735__auto__,active_home){
return (function (){
var G__47270 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-home","active-home",53621216),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__47270) : re_frame.core.dispatch.call(null,G__47270));
});})(item,s__47262__$2,temp__5735__auto__,active_home))
], null),jasminegui$home$nav_home_bar_$_iter__47261(cljs.core.rest(s__47262__$2)));
}
} else {
return null;
}
...
var active_home = cljs.core.deref((function (){var G__47271 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-home","active-home",53621216)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__47271) : re_frame.core.subscribe.call(null,G__47271));
})());
window.scrollTo((0),(0));

var G__47272 = active_home;
