...
0===option.indexOf(input):-1<option.indexOf(input)}):options;return"number"===typeof limit?options.slice(0,limit):options}}function findIndex(array,comp){for(let i=0;i<array.length;i+=1)if(comp(array[i]))return i;return-1}"use client";global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports.createFilterOptions=createFilterOptions;exports.useAutocomplete=function(props){function validOptionIndex(index,direction){if(!listboxRef.current||
