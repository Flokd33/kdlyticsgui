...
1,extra=!0,offset$jscomp$0=0):(band$jscomp$0=.5,extra=!1):(band$jscomp$0=_$jscomp$0("bandPosition"),extra=_$jscomp$0("tickExtra"));var JSCompiler_object_inline_extra_3532=extra;var JSCompiler_object_inline_band_3533=band$jscomp$0;var JSCompiler_object_inline_offset_3534=offset$jscomp$0;const datum={scale:_$jscomp$1.scale,ticks:!!_$jscomp$0("ticks"),labels:!!_$jscomp$0("labels"),grid:!!_$jscomp$0("grid"),domain:!!_$jscomp$0("domain"),title:null!=_$jscomp$1.title},dataRef=ref$jscomp$0(scope.add(Collect({},
[datum]))),ticksRef=ref$jscomp$0(scope.add(AxisTicks({scale:scope.scaleRef(_$jscomp$1.scale),extra:scope.property(JSCompiler_object_inline_extra_3532),count:scope.objectProperty(_$jscomp$1.tickCount),values:scope.objectProperty(_$jscomp$1.values),minstep:scope.property(_$jscomp$1.tickMinStep),formatType:scope.property(_$jscomp$1.formatType),formatSpecifier:scope.property(_$jscomp$1.format)}))),children=[];let size;if(datum.grid){var JSCompiler_temp_const$jscomp$1=children.push,userEncode=encode$jscomp$0.grid;
...
{stroke:_("gridColor"),strokeCap:_("gridCap"),strokeDash:_("gridDash"),strokeDashOffset:_("gridDashOffset"),strokeOpacity:_("gridOpacity"),strokeWidth:_("gridWidth")});const tickPos={scale:_$jscomp$1.scale,field:"value",band:JSCompiler_object_inline_band_3533,extra:JSCompiler_object_inline_extra_3532,offset:JSCompiler_object_inline_offset_3534,round:_("tickRound")},sz=ifX(orient,{signal:"height"},{signal:"width"}),gridStart=vscale?{scale:vscale,range:0,mult:sign,offset}:{value:0,offset},gridEnd=vscale?
...
symbolBaseFillColor:"transparent",symbolBaseStrokeColor:"#888",titleLimit:180,titleOrient:"top",titlePadding:5,layout:{offset:18,direction:"horizontal",left:{direction:"vertical"},right:{direction:"vertical"}}},range:{category:{scheme:"tableau10"},ordinal:{scheme:"blues"},heatmap:{scheme:"yellowgreenblue"},ramp:{scheme:"blues"},diverging:{scheme:"blueorange",extent:[1,0]},symbol:"circle square triangle-up cross diamond triangle-right triangle-down triangle-left".split(" ")}}}const encoder=_=>vegaUtil.isObject(_)&&
!vegaUtil.isArray(_)?vegaUtil.extend({},_):{value:_},scaleRef=scale=>vegaUtil.isString(scale)?vegaUtil.stringValue(scale):scale.signal?`(${scale.signal})`:field$jscomp$0(scale),_color=(type,x,y,z)=>`(${type}(${[x,y,z].map(entry$1).join(",")})+'')`,OUTER_INVALID=["value","update","init","react","bind"],keyFieldRef=fieldRef$1("key"),OP_VALUE_EXPR={code:"_.$value",ast:{type:"Identifier",value:"value"}},transform$jscomp$0=name=>(params,value,parent)=>new Entry(name,value,params||void 0,parent),Aggregate=
transform$jscomp$0("aggregate"),AxisTicks=transform$jscomp$0("axisticks"),Bound=transform$jscomp$0("bound"),Collect=transform$jscomp$0("collect"),Compare=transform$jscomp$0("compare"),DataJoin=transform$jscomp$0("datajoin"),Encode=transform$jscomp$0("encode"),Expression=transform$jscomp$0("expression"),Facet=transform$jscomp$0("facet"),Field=transform$jscomp$0("field"),Key=transform$jscomp$0("key"),LegendEntries=transform$jscomp$0("legendentries"),Load=transform$jscomp$0("load"),Mark=transform$jscomp$0("mark"),
...
"axis-grid";exports.AxisLabelRole="axis-label";exports.AxisRole="axis";exports.AxisTickRole="axis-tick";exports.AxisTitleRole="axis-title";exports.DataScope=DataScope;exports.FrameRole="frame";exports.LegendEntryRole="legend-entry";exports.LegendLabelRole="legend-label";exports.LegendRole="legend";exports.LegendSymbolRole="legend-symbol";exports.LegendTitleRole="legend-title";exports.MarkRole="mark";exports.Scope=Scope;exports.ScopeRole="scope";exports.config=defaults;exports.parse=function(spec,
config,options){vegaUtil.isObject(spec)||vegaUtil.error("Input Vega specification must be an object.");config=vegaUtil.mergeConfig(defaults(),config,spec.config);return parseView(spec,new Scope(config,options)).toRuntime()};exports.signal=parseSignal;exports.signalUpdates=parseSignalUpdates;exports.stream=parseStream})}
