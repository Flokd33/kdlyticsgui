...
_):{value:_}}function addEncode(object,name,value,set){return null!=value?(vegaUtil.isObject(value)&&!vegaUtil.isArray(value)?object.update[name]=value:object[set||"enter"][name]={value:value},1):0}function addEncoders(object,enter,update){for(var name in enter)addEncode(object,name,enter[name]);for(var name$337 in update)addEncode(object,name$337,update[name$337],"update")}function extendEncode(encode,extra,skip){for(var name in extra)skip&&vegaUtil.hasOwnProperty(skip,name)||(encode[name]=vegaUtil.extend(encode[name]||
