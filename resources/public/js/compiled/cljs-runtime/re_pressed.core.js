...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","add-keyboard-event-listener","re-pressed.core/add-keyboard-event-listener",719500381),(function (_,p__43627){
var vec__43638 = p__43627;
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keydown-rules","re-pressed.core/set-keydown-rules",1002257871),(function (p__43654,p__43655){
var map__43656 = p__43654;
var map__43656__$1 = cljs.core.__destructure_map(map__43656);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43656__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var opts = map__43660__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43660__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43660__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43660__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
var prevent_default_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43660__$1,new cljs.core.Keyword(null,"prevent-default-keys","prevent-default-keys",1744205310));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keypress-rules","re-pressed.core/set-keypress-rules",1541561860),(function (p__43664,p__43665){
var map__43667 = p__43664;
var map__43667__$1 = cljs.core.__destructure_map(map__43667);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43667__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43668 = p__43665;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43668,(0),null);
var map__43671 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43668,(1),null);
var map__43671__$1 = cljs.core.__destructure_map(map__43671);
var opts = map__43671__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43671__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43671__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43671__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keyup-rules","re-pressed.core/set-keyup-rules",519284589),(function (p__43677,p__43678){
var map__43679 = p__43677;
var map__43679__$1 = cljs.core.__destructure_map(map__43679);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43679__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43680 = p__43678;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43680,(0),null);
var map__43683 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43680,(1),null);
var map__43683__$1 = cljs.core.__destructure_map(map__43683);
var opts = map__43683__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43683__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43683__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43683__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
