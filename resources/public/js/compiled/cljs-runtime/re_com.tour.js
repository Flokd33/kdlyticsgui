...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42839_SHARP_,p2__42840_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__42839_SHARP_,p2__42840_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__42841(s__42842){
return (new cljs.core.LazySeq(null,(function (){
var s__42842__$1 = s__42842;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__42842__$1);
if(temp__5804__auto__){
var s__42842__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42842__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__42842__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__42844 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__42843 = (0);
while(true){
if((i__42843 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__42843);
cljs.core.chunk_append(b__42844,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__42861 = (i__42843 + (1));
i__42843 = G__42861;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42844),re_com$tour$initialise_tour_$_iter__42841(cljs.core.chunk_rest(s__42842__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42844),null);
}
} else {
var step = cljs.core.first(s__42842__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__42841(cljs.core.rest(s__42842__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__42847 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__42847.cljs$core$IFn$_invoke$arity$1 ? fexpr__42847.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__42847.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__42850 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__42850.cljs$core$IFn$_invoke$arity$1 ? fexpr__42850.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__42850.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__42851 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__42851.cljs$core$IFn$_invoke$arity$1 ? fexpr__42851.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__42851.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__42856 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__42856.cljs$core$IFn$_invoke$arity$1 ? fexpr__42856.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__42856.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__42857 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__42857.cljs$core$IFn$_invoke$arity$1 ? fexpr__42857.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__42857.call(null,tour));
})(),true);
} else {
return null;
}
