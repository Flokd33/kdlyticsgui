...
kdlyticsgui.guitools.switch_helix = (function (){var G__30279 = (function kdlyticsgui$guitools$switch_helix_render(props__29229__auto__,maybe_ref__29230__auto__){
var vec__30280 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__29229__auto__),maybe_ref__29230__auto__], null);
var map__30283 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30280,(0),null);
var map__30283__$1 = cljs.core.__destructure_map(map__30283);
var checked_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30283__$1,new cljs.core.Keyword(null,"checked-atom","checked-atom",-1948477891));
var default_checked = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30283__$1,new cljs.core.Keyword(null,"default-checked","default-checked",1039965863));

var vec__30284 = helix.hooks.use_state(default_checked);
var checked = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30284,(0),null);
var setChecked = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30284,(1),null);
var x = (function (){var G__30287 = helix.hooks.wrap_fx((function (){
return cljs.core.reset_BANG_(checked_atom,checked);
}));
var G__30288 = [checked];
return (helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2(G__30287,G__30288) : helix.hooks.raw_use_effect.call(null,G__30287,G__30288));
})();
return helix.core.get_react().createElement(module$node_modules$$mui$material$node$index.Switch,(function (){var obj30290 = ({"size":"small","checked":checked,"onChange":(function (e){
var G__30291 = (e["target"]["checked"]);
return (setChecked.cljs$core$IFn$_invoke$arity$1 ? setChecked.cljs$core$IFn$_invoke$arity$1(G__30291) : setChecked.call(null,G__30291));
})});
return obj30290;
})());
});
if(goog.DEBUG === true){
var G__30292 = G__30279;
(G__30292.displayName = "kdlyticsgui.guitools/switch-helix");
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-table-js-state","update-table-js-state",-120377066),(function (db,p__30308){
var vec__30309 = p__30308;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30309,(0),null);
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30309,(1),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30309,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30309,(3),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(db,cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(table,"mrt-table-state"),(function (p1__30307_SHARP_){
return cljs.core.clj__GT_js(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(item,"columnFilters"))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__30307_SHARP_),item,value):cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__30307_SHARP_),item,value,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expanded","dummy:"], 0))));
}));
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tree-table-toggle-esg","tree-table-toggle-esg",-2109727108),(function (db,p__30313){
var vec__30314 = p__30313;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30314,(0),null);
var display_style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30314,(1),null);
var grouping = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(display_style,"sector"))?"sector":"country");
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword("esg","data-tree","esg/data-tree",1310238199),(!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(display_style,"no")))),new cljs.core.Keyword("esg","mrt-table-state","esg/mrt-table-state",-372208931),(function (p1__30312_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(display_style,"no")){
return kdlyticsgui.guitools.update_js_map.cljs$core$IFn$_invoke$arity$5(p1__30312_SHARP_,"grouping",cljs.core.PersistentVector.EMPTY,"expanded",cljs.core.PersistentArrayMap.EMPTY);
} else {
return kdlyticsgui.guitools.update_js_map.cljs$core$IFn$_invoke$arity$5(p1__30312_SHARP_,"grouping",cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [grouping], null)),"expanded",cljs.core.PersistentArrayMap.EMPTY);
}
}));
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tree-table-toggle-ta","tree-table-toggle-ta",-997395897),(function (db,p__30318){
var vec__30319 = p__30318;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30319,(0),null);
var grp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30319,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword("ta-trade-view","mrt-table-state","ta-trade-view/mrt-table-state",1059210316),(function (p1__30317_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(grp,"No")){
return kdlyticsgui.guitools.update_js_map.cljs$core$IFn$_invoke$arity$5(p1__30317_SHARP_,"grouping",cljs.core.PersistentVector.EMPTY,"expanded",cljs.core.PersistentArrayMap.EMPTY);
} else {
return kdlyticsgui.guitools.update_js_map.cljs$core$IFn$_invoke$arity$5(p1__30317_SHARP_,"grouping",cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["dummy"], null)),"expanded",new cljs.core.PersistentArrayMap(null, 1, ["dummy:",true], null));
}
}));
}));
...
var all_cols = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(tbl.getAllColumns().filter((function (p1__30322_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30322_SHARP_.id,"mrt-row-expand");
})).map((function (c){
...
}),(function (){var G__30324 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(grouping,extra_pins);
var fexpr__30323 = (cljs.core.truth_(table_QMARK_)?cljs.core.identity:cljs.core.rest);
return (fexpr__30323.cljs$core$IFn$_invoke$arity$1 ? fexpr__30323.cljs$core$IFn$_invoke$arity$1(G__30324) : fexpr__30323.call(null,G__30324));
})())));
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"20px",new cljs.core.Keyword(null,"class","class",-2030961996),"leftnavbar",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function kdlyticsgui$guitools$left_nav_bar_$_iter__30325(s__30326){
...
var item = cljs.core._nth(c__5521__auto__,i__30327);
cljs.core.chunk_append(b__30328,cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key], null))),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__30327,item,c__5521__auto__,size__5522__auto__,b__30328,s__30326__$2,temp__5804__auto__){
return (function (){
...
});})(i__30327,item,c__5521__auto__,size__5522__auto__,b__30328,s__30326__$2,temp__5804__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)));

var G__30332 = (i__30327 + (1));
i__30327 = G__30332;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30328),kdlyticsgui$guitools$left_nav_bar_$_iter__30325(cljs.core.chunk_rest(s__30326__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30328),null);
}
} else {
var item = cljs.core.first(s__30326__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),["btn btn-primary btn-block",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key], null))),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)))?" active":null)].join(''),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (item,s__30326__$2,temp__5804__auto__){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [navigation_key,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(item)], null));
});})(item,s__30326__$2,temp__5804__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)),kdlyticsgui$guitools$left_nav_bar_$_iter__30325(cljs.core.rest(s__30326__$2)));
}
} else {
return null;
}
