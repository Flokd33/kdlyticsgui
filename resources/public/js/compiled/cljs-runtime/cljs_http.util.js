...
var vec__54639 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54639,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54639,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__54647){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54648__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54648__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54648__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54648__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54648__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__54656 = (new goog.Uri());
G__54656.setScheme(cljs.core.name((function (){var or__4126__auto__ = scheme;
...
G__54656.setDomain(server_name);

G__54656.setPort(server_port);

G__54656.setPath(uri);

G__54656.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__54678_SHARP_,p2__54677_SHARP_){
var vec__54679 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__54677_SHARP_,/:\s+/);
...
return p1__54678_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__54678_SHARP_,clojure.string.lower_case(k),v);
}
