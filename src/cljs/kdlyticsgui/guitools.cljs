...
(defn mui-dev []
  (let [portfolio ["PORTFOLIO 1" "PORTFOLIO 2"]
    ...
    [v-box :gap "30px"
     :children [[h-box :class "subbody rightelement" :gap "20px" :children [[v-box :children
                                                                             [($ mui/slider-simple {:width "200px" :on-change #(reset! slider-result (mui/event-value %))})
                                                                              [gap :size "10px"]
                                                                              ($ mui/text-simple {:variant "body1" :text @slider-result})]
                                                                             ]
                                                                            ...
                                                                            [v-box :children
                                                                             [($ mui/select-input-simple {:label-text "Portfolio"
                                                                              ...
                                                                              [gap :size "10px"]
                                                                              ($ mui/text-simple {:variant "body1" :text @select-result})]
                                                                             ]
                                                                            ...
                                                                            ;  [gap :size "10px"]
                                                                            ;  ($ mui/text-simple {:variant "body1" :text @grouping-result})]
                                                                            ; ]
                                                                            ...
                                                                            [v-box :children
                                                                             [($ mui/select-input-search {:label-text "Select a portfolio"
                                                                              ...
                                                                              [gap :size "10px"]
                                                                              ($ mui/text-simple {:variant "body1" :text @autocomplete-result})]
                                                                             ]
                                                                            ...
                                                                            [v-box :children
                                                                             [($ mui/radio-group-button {:title "Make a choice"
                                                                              ...
                                                                              [gap :size "10px"]
                                                                              ($ mui/text-simple {:variant "body1" :text @radio-group-result})
                                                                              ]
                                                                             ]
                                                                            ...
                                                                            [v-box :children
                                                                             [($ mui/button-simple {:variant "contained" :text "Fetch" :on-click #(reset! button-result "Fetch") })
                                                                              ...
                                                                              [gap :size "10px"]
                                                                              ($ mui/text-simple {:variant "body1" :text @button-result})]
                                                                             ]
                                                                            ;[v-box :children
                                                                            ...
                                                                            ;  [gap :size "10px"]
                                                                            ;  ($ mui/text-simple {:variant "body1" :text @start-date-result})
                                                                            ;  ]
                                                                            ; ]
