...
(def main-navigation                                        ;:get-pivoted-positions                                       ;
  ...
  [{:code :home             :name "Holdings"          :dispatch :home             :subs nil :load-events (conj home-events :get-list-dates-position-history :get-portfolio-checks :get-quant-model ) :mounting-modal true}
   ...
   {:code :esg              :name "ESG"               :dispatch :esg              :subs nil :load-events (concat home-events [:get-esg-report-list  [:post-esg-report-extract "USY1753QAB87" "2022-08-18"]  :get-analysts :get-country-codes :get-refinitiv-ids :get-refinitiv-structure :get-msci-scores :get-quant-model])}
